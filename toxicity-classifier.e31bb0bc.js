...
exports.getKernel = c;
exports.getKernelsForBackend = l;
exports.grad = to;
exports.grads = eo;
exports.keep = $e;
exports.linspace = Wn;
exports.memory = qe;
exports.nextFrame = lp;
exports.ones = Bn;
exports.op = Cn;
exports.print = ur;
exports.profile = Ke;
...
exports.tidy = je;
exports.time = Ye;
exports.unregisterKernel = f;
exports.valueAndGrad = no;
exports.valueAndGrads = ro;
exports.variable = Mn;
exports.variableGrads = oo;
exports.zeros = Pn;
...
function w(t, e, n) {
  if (void 0 === e && (e = []), void 0 === n && (n = !1), null == e && (e = []), Array.isArray(t) || P(t) && !n) for (var r = 0; r < t.length; ++r) w(t[r], e, n);else e.push(t);
  return e;
}
...
function N(t, e) {
  for (var n = [], r = [], o = null != e && Array.isArray(e) && 0 === e.length, a = null == e || o ? null : T(e, t).sort(), i = 0, s = 0; s < t.length; ++s) {
    if (null != a) {
...
function G(t) {
  return Array.isArray(t) ? G(t[0]) : t instanceof Float32Array ? "float32" : t instanceof Int32Array || t instanceof Uint8Array ? "int32" : z(t) ? "float32" : U(t) ? "string" : V(t) ? "bool" : "float32";
}
...
function j(t, e, n) {
  ...
  if (Array.isArray(t) && (t = w(t)), n && O(t, e), function (t, e) {
...
function J(t) {
  t.forEach(function (e) {
    y(Number.isInteger(e) && e >= 0, function () {
...
var et = Object.freeze({
  ...
  decodeString: tt
    ...
    nt = function () {
  function t(t, e) {
    this.backendTimer = t, this.logger = e, null == e && (this.logger = new rt());
  }
...
function st(t, e, n, r) {
  var o = K(e),
    ...
    var o = C(e),
        ...
        s = e.length,
        u = "complex64" === n ? lt(t) : t;
    if (s > 1) for (var c = 0; c < o / a; c++) for (var l = c * a, h = 0; h < a; h++) i[h] = Math.max(i[h], ut(u[l + h], 0, n).length);
    return i;
  }(t, e, n, o),
      i = e.length,
    ...
    if (0 === c) {
      return "complex64" === r ? [ut(lt(e)[0], 0, r)] : "bool" === r ? [ct(e[0])] : [e[0].toString()];
    }
    ...
    if (1 === c) {
      if (u > ot) {
        var l = at * s,
            ...
            f = Array.from(e.slice((u - at) * s, u * s));
        return "complex64" === r && (h = lt(h), f = lt(f)), ["[" + h.map(function (t, e) {
          return ut(t, a[e], r);
        }).join(", ") + ", ..., " + f.map(function (t, e) {
          return ut(t, a[u - at + e], r);
        }).join(", ") + "]"];
      }

      return ["[" + ("complex64" === r ? lt(e) : Array.from(e)).map(function (t, e) {
        return ut(t, a[e], r);
      }).join(", ") + "]"];
    }
    ...
    if (u > ot) {
      for (var m = 0; m < at; m++) {
        var y = (x = m * v) + v;
        g.push.apply(g, t(e.slice(x, y), p, r, d, a, !1));
      }
      ...
      for (m = u - at; m < u; m++) {
        y = (x = m * v) + v;
        g.push.apply(g, t(e.slice(x, y), p, r, d, a, m === u - 1));
      }
    } else for (m = 0; m < u; m++) {
      var x;
      y = (x = m * v) + v;
...
function ut(t, e, n) {
  return S(Array.isArray(t) ? parseFloat(t[0].toFixed(it)) + " + " + parseFloat(t[1].toFixed(it)) + "j" : U(t) ? "'" + t + "'" : "bool" === n ? ct(t) : parseFloat(t.toFixed(it)).toString(), e);
}
...
var ht = function () {
  function t(t, e, n) {
    ...
    if (this.dtype = e, this.shape = t.slice(), this.size = C(t), null != n) {
      var o = n.length;
      y(o === this.size, function () {
    ...
    this.values = n || _(e, this.size), this.strides = K(t);
  }

  return t.prototype.set = function (t) {
    for (var e = this, n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];

    0 === n.length && (n = [0]), y(n.length === this.rank, function () {
    ...
    return ft().makeTensor(this.values, this.shape, this.dtype);
  }, t;
}(),
    ft = null,
    pt = null,
...
exports.TensorBuffer = ht;

var vt = function () {
  function t(t, e, n, r) {
    this.kept = !1, this.isDisposedInternal = !1, this.shape = t.slice(), this.dtype = e || "float32", this.size = C(t), this.strides = K(t), this.dataId = n, this.id = r, this.rankType = this.rank < 5 ? this.rank.toString() : "higher";
  }

  return t.prototype.flatten = function () {
    return this.throwIfDisposed(), this.as1D();
  }, t.prototype.asScalar = function () {
    return this.throwIfDisposed(), y(1 === this.size, function () {
    ...
    return n(this, void 0, void 0, function () {
      ...
      return r(this, function (e) {
        switch (e.label) {
          ...
          case 1:
            return t = e.sent(), [2, pt.buffer(this.shape, this.dtype, t)];
        }
      });
    });
    ...
    return n(this, void 0, void 0, function () {
      ...
      return r(this, function (e) {
        switch (e.label) {
          ...
          case 1:
            return t = e.sent(), [2, X(this.shape, t)];
        }
      });
    });
    ...
    return n(this, void 0, void 0, function () {
      ...
      return r(this, function (n) {
        switch (n.label) {
          case 0:
            return this.throwIfDisposed(), t = ft().read(this.dataId), "string" !== this.dtype ? [3, 2] : [4, t];
    ...
    return n(this, void 0, void 0, function () {
      ...
      return r(this, function (e) {
        switch (e.label) {
          case 0:
            return this.throwIfDisposed(), [4, ft().read(this.dataId)];
    ...
    this.isDisposed || (ft().disposeTensor(this), this.isDisposedInternal = !0);
    ...
    return void 0 === t && (t = !1), st(this.dataSync(), this.shape, this.dtype, t);
    ...
    return void 0 === n && (n = 0), this.throwIfDisposed(), e instanceof t && (e = [e]), pt.concat([this].concat(e), n);
    ...
    return void 0 === n && (n = .001), dt("tf.batchNormalization() is going away. Use tf.batchNorm() instead, and note the positional argument change of scale, offset, and varianceEpsilon"), this.batchNorm(t, e, o, r, n);
    ...
    return this.throwIfDisposed(), pt.divNoNan(this, t);
    ...
    return this.throwIfDisposed(), pt.relu6(this);
    ...
    return void 0 === r && (r = "NWC"), void 0 === o && (o = 1), this.throwIfDisposed(), pt.conv1d(this, t, e, n, r, o, a);
  }, t.prototype.conv2d = function (t, e, n, r, o, a) {
    return void 0 === r && (r = "NHWC"), void 0 === o && (o = [1, 1]), this.throwIfDisposed(), pt.conv2d(this, t, e, n, r, o, a);
    ...
    return void 0 === r && (r = "NHWC"), void 0 === o && (o = [1, 1]), this.throwIfDisposed(), pt.depthwiseConv2d(this, t, e, n, r, o, a);
  }, t.prototype.separableConv2d = function (t, e, n, r, o, a) {
    return void 0 === o && (o = [1, 1]), void 0 === a && (a = "NHWC"), this.throwIfDisposed(), pt.separableConv2d(this, t, e, n, r, o, a);
    ...
    return void 0 === t && (t = !0), this.throwIfDisposed(), ft().makeVariable(this, t, e, n);
    ...
    return void 0 === r && (r = 0), void 0 === o && (o = 0), void 0 === a && (a = 0), void 0 === i && (i = 0), void 0 === s && (s = 0), this.throwIfDisposed(), pt.stridedSlice(this, t, e, n, r, o, a, i, s);
...
var gt,
  ...
  return e(n, t), n.prototype.assign = function (t) {
    ...
    ft().disposeTensor(this), this.dataId = t.dataId, ft().incRef(this, null);
  }, n.prototype.dispose = function () {
    ft().disposeVariable(this), this.isDisposedInternal = !0;
  }, n;
}(vt);
...
function It(t, e) {
  ...
  var n = Et(t.dtype, e.dtype);
  return [t.cast(n), e.cast(n)];
}

function kt(t, e) {
  y(t.dtype === e.dtype, function () {
...
function St(t) {
  ...
  return function t(e, n, r) {
    if (null == e) return;
    if (e instanceof vt) return void n.push(e);
...
var At,
  ...
  return t.prototype.ready = function () {
    ...
    return n(this, void 0, void 0, function () {
      ...
      return r(this, function (r) {
        switch (r.label) {
          ...
          case 4:
            return this.backendInstance = this.registry[t], this.setupRegisteredKernels(), this.profiler = new nt(this.backendInstance), [2, !0];
        }
      });
    });
  }, t.prototype.setupRegisteredKernels = function () {
    var t = this;
    l(this.backendName).forEach(function (e) {
    ...
    }), f && this.addTapeNode(p, e, s, n, h), this.state.profiling && this.state.activeProfile.kernels.push({
      name: p,
    ...
    var o = t;
    "string" === n && U(t[0]) && (o = t.map(function (t) {
      return Z(t);
    }));
    var a = r.write(o, e, n),
        i = new vt(e, n, a, this.nextTensorId());
    ...
    var o = new wt(t, e, n, this.nextTensorId());
    ...
    if (this.state.numTensors++, "string" === t.dtype && this.state.numStringTensors++, 0 === n) {
      ...
      var r = 0;
      "complex64" !== t.dtype && "string" !== t.dtype && (r = t.size * L(t.dtype)), this.state.tensorInfo.set(t.dataId, {
    ...
    var o = this;
    if (void 0 === r && (r = !1), y(e.length > 0, function () {
    ...
    var i = function (t, e, n) {
      ...
      for (a = t.length - 1; a >= 0; a--) for (i = (d = t[a]).inputs, l = 0; l < d.outputs.length; l++) if (h[d.outputs[l].id]) {
        for (var s in i) h[i[s].id] = !0, f[d.id] = !0;
      ...
      for (a = 0; a < t.length; a++) {
        ...
        if (o[(d = t[a]).id] && f[d.id]) {
          ...
          m.inputs = v, m.outputs = d.outputs, p.push(m);
        }
      }
    ...
    return this.tidy("backward", function () {
      var t,
          r,
          s = {};
      s[a.id] = null == n ? (t = a.shape, r = $(C(t), "float32"), Ft.makeTensor(r, t, "float32")) : n, function (t, e, n) {
        for (var r = function (r) {
          ...
          var i = o.gradient(a),
            ...
            var a = o.inputs[e];
            if (!E(r.shape, a.shape)) throw new Error("Error in gradient for op " + o.name + ". The gradient of input '" + e + "' has shape '" + r.shape + "', which does not match the shape of the input '" + a.shape + "'");
    ...
    return y(H(t), function () {
      ...
      return r.forEach(function (t, e) {
        ...
        return y((n = t.apply(void 0, r.concat([o]))).value instanceof vt, function () {
          return "The function f passed in customGrad(f) must return an object where `obj.value` is a tensor";
        }), y(H(n.gradFunc), function () {
          return "The function f passed in customGrad(f) must return an object where `obj.gradFunc` is a function.";
        }), n.value;
      }, a, function (t, e) {
        var o = n.gradFunc(t, e),
            a = Array.isArray(o) ? o : [o];
        y(a.length === r.length, function () {
          return "The function f passed in customGrad(f) must return an object where `obj.gradFunc` is a function that returns the same number of tensors as inputs passed to f(...).";
        }), y(a.every(function (t) {
          return t instanceof vt;
        }), function () {
    ...
    return n(this, void 0, void 0, function () {
      ...
      return r(this, function (r) {
        switch (r.label) {
          case 0:
            return e = Q(), [4, this.backend.time(t)];

          case 1:
            return (n = r.sent()).wallMs = Q() - e, [2, n];
        }
      });
    });
    ...
    for (var t in this.pendingBackendInitId++, this.state.dispose(), this.ENV.reset(), this.state = new Tt(), this.registry) this.disposeRegisteredKernels(t), this.registry[t].dispose(), delete this.registry[t];

    this.backendName = null, this.backendInstance = null, this.pendingBackendInit = null;
  }, t.nextTensorId = 0, t.nextVariableId = 0, t;
}();

exports.tensor_util = Dt;
...
function Vt(t) {
  t in Lt || (Lt[t] = function (t) {
    ...
    }, !1), 1 === t) return e.getContext("webgl", Wt) || e.getContext("experimental-webgl", Wt);
    return e.getContext("webgl2", Wt);
  }(t));
  var e = Lt[t];
  return e.isContextLost() ? (delete Lt[t], Vt(t)) : (e.disable(e.DEPTH_TEST), e.disable(e.STENCIL_TEST), e.disable(e.BLEND), e.disable(e.DITHER), e.disable(e.POLYGON_OFFSET_FILL), e.disable(e.SAMPLE_COVERAGE), e.enable(e.SCISSOR_TEST), e.enable(e.CULL_FACE), e.cullFace(e.BACK), Lt[t]);
}
...
function $t(t) {
  return !!(i().getBool("WEBGL_RENDER_FLOAT32_ENABLED") || 0 === t || jt < Math.abs(t) && Math.abs(t) < Xt);
}
...
function Ce(t, e) {
  return void 0 === e && (e = 2), C(t.slice(0, t.length - e));
}
...
function Ie(t, e) {
  ...
  if (e) {
    var s = Ce(t),
        u = 2,
        c = 2;
    return t.length && (u = (n = Ee(t))[0], c = n[1]), k(a = s * (u / 2) * (c / 2)).map(function (t) {
      return 2 * t;
    });
  }
...
var Pe = Object.freeze({
  ...
  isDownloadFloatTextureEnabled: Oe,
...
function en(t) {
  return Ft.findBackend(t);
}

function nn(t) {
  return Ft.findBackendFactory(t);
}

function rn(t, e, n) {
  return void 0 === n && (n = 1), Ft.registerBackend(t, e, n);
}
...
function ln(t, e, n, r) {
  if (void 0 === r && (r = "numeric"), t instanceof vt) return cn(r, t.dtype, e, n), t;
  var o = G(t);

  if ("string" !== o && ["bool", "int32", "float32"].indexOf(r) >= 0 && (o = r), cn(r, o, e, n), null == t || !P(t) && !Array.isArray(t) && "number" != typeof t && "boolean" != typeof t && "string" != typeof t) {
  ...
  var u = "string" !== o ? j(t, o, i().getBool("DEBUG")) : w(t, [], !0);
  return Ft.makeTensor(u, s, o);
}
...
function bn(t, e) {
  ...
  t.forEach(function (t, o) {
    for (var a = 0; a < n; a++) y(a === e || t[a] === r[a], function () {
...
function Cn(t) {
  ...
  var o = function () {
    ...
    try {
      ...
      return o instanceof Promise && console.error("Cannot return a Promise inside of tidy."), Ft.endScope(o), o;
    } catch (t) {
...
var En = Cn({
  complex_: function (t, e) {
    var n = ln(t, "real", "complex"),
        r = ln(e, "imag", "complex");
    return x(n.shape, r.shape, "real and imag shapes, " + n.shape + " and " + r.shape + ", must match in call to tf.complex()."), Ft.runKernelFunc(function (t) {
  ...
  real_: function (t) {
    ...
    return Ft.runKernelFunc(function (t) {
      return t.real(e);
    }, {
      $input: e
    });
...
function kn(t, e, n) {
  return Sn(t, e, un(t, n), n);
}

function Sn(t, e, n, r) {
  if (null == r && (r = G(t)), "complex64" === r) throw new Error("Cannot construct a complex64 tensor directly. Please use tf.complex(real, imag).");
  if (!P(t) && !Array.isArray(t) && "number" != typeof t && "boolean" != typeof t && "string" != typeof t) throw new Error("values passed to tensor(values) must be a number/boolean/string or an array of numbers/booleans/strings, or a TypedArray");
  ...
  if (null != e) {
    ...
    for (var s = 0; s < n.length; ++s) {
      var u = n[s],
          c = s !== n.length - 1 || u !== C(e.slice(s));
      y(n[s] === e[s] || !c, function () {
        return "Error creating a new Tensor. Inferred shape (" + n + ") does not match the provided shape (" + e + "). ";
      });
    }
  }

  return P(t) || Array.isArray(t) || (t = [t]), e = e || n, t = "string" !== r ? j(t, r, i().getBool("DEBUG")) : w(t, [], !0), Ft.makeTensor(t, e, r);
}

function An(t, e) {
  if ((P(t) && "string" !== e || Array.isArray(t)) && "complex64" !== e) throw new Error("Error creating a new Scalar: value must be a primitive (number|boolean|string)");
  if ("string" === e && P(t) && !(t instanceof Uint8Array)) throw new Error("When making a scalar from encoded string, the value must be `Uint8Array`.");
  return Sn(t, [], [], e);
}
...
function Un(t, e, n, r) {
  ...
  var o = Y(Math.abs(Math.ceil((e - t) / n)), r);
  e < t && 1 === n && (n = -1), o[0] = t;
...
var Gn = Cn({
  concat_: function (t, e) {
    void 0 === e && (e = 0), y(t.length >= 1, function () {
  ...
  split_: function (t, e, n) {
    ...
    var r,
        o = ln(t, "x", "split");
    return n = T(n, o.shape)[0], "number" == typeof e ? (y(o.shape[n] % e == 0, function () {
      return "Number of splits must evenly divide the axis.";
    }), r = new Array(e).fill(o.shape[n] / e)) : (y(o.shape[n] === e.reduce(function (t, e) {
      return t + e;
    }), function () {
      return "The sum of sizes must match the size of the axis dimension.";
    }), r = e), Ft.runKernelFunc(function (t) {
...
function sr(t, e, n) {
  return void 0 === e && (e = "float32"), e = e || "float32", J(t), new ht(t, e, n);
}
...
var cr = Cn({
  ...
  broadcastTo_: function (t, e) {
    ...
    return 0 === s.length ? n.clone() : Ft.runKernelFunc(function (t) {
      return t.tile(n, a);
    }, {
      input: n
    }, function (t) {
  ...
  cast_: function (t, e) {
    var n = ln(t, "x", "cast");
    if (!M(e)) throw new Error("Failed to cast to unknown dtype " + e);
  ...
  clone_: function (t) {
    ...
    return Ft.runKernelFunc(function () {
  ...
  expandDims_: function (t, e) {
    ...
    var r = n.shape.slice();
    return e < 0 && (y(-(n.rank + 1) <= e, function () {
  ...
  eye_: function (t, e, n, r) {
    ...
    for (var o = sr([t, e], r), a = t <= e ? t : e, i = 0; i < a; ++i) o.set(1, i, i);

    var s = o.toTensor().as2D(t, e);
    if (null == n) return s;
    if (1 === n.length) return Fr(vr(s, 0), [n[0], 1, 1]);
    if (2 === n.length) return Fr(vr(vr(s, 0), 0), [n[0], n[1], 1, 1]);
    if (3 === n.length) return Fr(vr(vr(vr(s, 0), 0), 0), [n[0], n[1], n[2], 1, 1]);
  ...
  oneHot_: function (t, e, n, r) {
    ...
    var o = ln(t, "indices", "oneHot", "int32"),
        a = o.shape.concat([e]);
    return o = o.flatten(), Ft.runKernelFunc(function (t) {
  ...
  pad1d_: function (t, e, n) {
    return void 0 === n && (n = 0), y(2 === e.length, function () {
  ...
  pad2d_: function (t, e, n) {
    return void 0 === n && (n = 0), y(2 === e.length && 2 === e[0].length && 2 === e[1].length, function () {
  ...
  pad3d_: function (t, e, n) {
    return void 0 === n && (n = 0), y(3 === e.length && 2 === e[0].length && 2 === e[1].length && 2 === e[2].length, function () {
      return "Invalid number of paddings. Must be length of 2 each.";
    }), xr(t, e, n);
  }
}),
  ...
  pad4d_: function (t, e, n) {
    return void 0 === n && (n = 0), y(4 === e.length && 2 === e[0].length && 2 === e[1].length && 2 === e[2].length && 2 === e[3].length, function () {
      return "Invalid number of paddings. Must be length of 2 each.";
    }), xr(t, e, n);
  }
}),
  ...
  randomNormal_: function (t, e, n, r, o) {
    ...
    for (var a = new or(e, n, r, !1, o), i = sr(t, r), s = 0; s < i.values.length; s++) i.values[s] = a.nextValue();
  ...
  randomGamma_: function (t, e, n, r, o) {
    ...
    for (var a = new ar(e, n, r, o), i = sr(t, r), s = 0; s < i.values.length; s++) i.values[s] = a.nextValue();
  ...
  randomUniform_: function (t, e, n, r, o) {
    ...
    for (var a = sr(t, r), i = new ir(e, n, null, o), s = 0; s < a.values.length; s++) a.values[s] = i.nextValue();
  ...
  reshape_: function (t, e) {
    ...
    e = D(e, n.size), y(n.size === C(e), function () {
  ...
  spaceToBatchND_: function (t, e, n) {
    ...
    }), y(r.shape.reduce(function (t, r, o) {
  ...
  squeeze_: function (t, e) {
    ...
    return Ar(n, N(n.shape, e).newShape);
  }
}),
    Nr = Cn({
  stack_: function (t, e) {
  ...
  tile_: function (t, e) {
    ...
    return Ft.runKernelFunc(function (t, r) {
      var o = t.tile(n, e);
      return r([n]), o;
    }, {
      x: n
  ...
  truncatedNormal_: function (t, e, n, r, o) {
    ...
    for (var a = new or(e, n, r, !0, o), i = sr(t, r), s = 0; s < i.values.length; s++) i.values[s] = a.nextValue();
  ...
  unstack_: function (t, e) {
    ...
    y(e >= -n.shape.length && e < n.shape.length, function () {
  ...
  return n(this, void 0, void 0, function () {
    ...
    return r(this, function (r) {
      switch (r.label) {
        case 0:
          return n = ln(t, "x", "setdiff1d"), o = ln(e, "y", "setdiff1d"), y(n.dtype === o.dtype, function () {
        ...
        case 2:
          ...
          for (c = new ht([u], n.dtype), l = new ht([u], "int32"), h = 0, f = 0; h < a.length; h++) s.has(a[h]) || (c.values[f] = a[h], l.values[f] = h, f++);
...
exports.setdiff1dAsync = Mr;
exports.unstack = Or;
exports.truncatedNormal = _r;
exports.tile = Fr;
exports.stack = Nr;
exports.squeeze = Tr;
exports.spaceToBatchND = Dr;
exports.reshape = Ar;
exports.randomUniform = Sr;
exports.randomGamma = kr;
exports.randomNormal = Ir;
exports.rand = Rr;
exports.pad4d = Er;
exports.pad3d = Cr;
exports.pad2d = wr;
...
exports.eye = gr;
exports.expandDims = vr;
exports.depthToSpace = dr;
exports.cumsum = pr;
exports.clone = fr;
exports.cast = hr;
exports.broadcastTo = lr;
...
function Gr(t) {
  return t <= zr ? t : q(t, Math.floor(Math.sqrt(t)));
}
...
function Yr(t, e, n, r, o) {
  ...
  var s = r[o];
  return a < 0 && (a += s), a = i > 0 ? v(0, a, s) : v(-1, a, s - 1);
}
...
var Zr = Object.freeze({
  assertParamsValid: Kr,
  maskToAxes: jr,
  computeOutShape: Xr,
  startForAxis: $r,
  stopForAxis: Yr,
  isSliceContinous: Qr,
  computeFlatOffset: Jr
});
exports.slice_util = Zr;
...
function to(t) {
  return y(H(t), function () {
    ...
    return Ft.tidy(function () {
      var e = Ft.gradients(function () {
        return t(r);
      }, [r], o),
          n = e.value,
          a = e.grads;
      return null != o && x(n.shape, o.shape, "The shape of dy passed in grad(f)(x, dy) must match the shape returned by f(x)"), io(a), a[0];
    });
  };
}
    ...
    return Ft.tidy(function () {
      var e = Ft.gradients(function () {
        return t.apply(void 0, r);
          ...
          n = e.value,
          a = e.grads;
      return null != o && x(n.shape, o.shape, "The shape of dy passed in grads(f)([x1,...], dy) must match the shape returned by f([x1,...])"), io(a), a;
    });
  };
}
...
function no(t) {
  return y(H(t), function () {
    ...
    y(e instanceof vt, function () {
      return "The x passed in valueAndGrad(f)(x) must be a tensor";
    }), y(null == n || n instanceof vt, function () {
      return "The dy passed in valueAndGrad(f)(x, dy) must be a tensor";
    });
    var r = Ft.gradients(function () {
      return t(e);
    }, [e], n),
        o = r.grads,
        a = r.value;
...
function ro(t) {
  return y(H(t), function () {
    ...
    y(Array.isArray(e) && e.every(function (t) {
      return t instanceof vt;
    }), function () {
    ...
    return null != n && x(r.value.shape, n.shape, "The shape of dy passed in valueAndGrads(f)([x1,...], dy) must match the shape returned by f([x1,...])"), io(r.grads), r;
  };
}
...
function oo(t, e) {
  ...
  }), y(null == e || Array.isArray(e) && e.every(function (t) {
    return t instanceof wt;
  }), function () {
    return "The varList passed in variableGrads(f, varList) must be an array of variables";
  });
  var n = null != e;
  if (!n) for (var r in e = [], Ft.registeredVariables) e.push(Ft.registeredVariables[r]);
  var o = n ? e.filter(function (t) {
    return !t.trainable;
  }) : null,
      a = e.length;
  y((e = e.filter(function (t) {
    return t.trainable;
  })).length > 0, function () {
...
var so = Cn({
  ...
  return t.prototype.time = function (t) {
    ...
    t.input, t.filter, t.convInfo, t.bias, t.activation, t.preluActivationWeights;
    return ho("fusedDepthwiseConv2D");
    ...
    return ho("cumsum");
  }, t.prototype.nonMaxSuppression = function (t, e, n, r, o, a) {
...
function yo(t, e, n, r, o, a, i, s) {
  ...
  var p,
    ...
    if ("number" == typeof t) {
      ...
      var h = function (t, e, n, r, o) {
        ...
        var u = Ro((i - e + 2 * r) / n + 1, o);
        return y(R(u), function () {
  ...
  return "channelsFirst" === s ? p = [c, N, D, T] : "channelsLast" === s && (p = [c, D, T, N]), {
    batchSize: c,
    dataFormat: s,
    inHeight: l,
    inWidth: h,
...
function xo(t, e, n, r, o, a, i, s) {
  ...
  var d,
    ...
    if ("number" == typeof t) {
      ...
      h = {
        ...
        back: 0,
        type: "VALID"
      }, f = Math.ceil((e - s + 1) / o), p = Math.ceil((n - u + 1) / a), d = Math.ceil((r - c + 1) / i);
    }
  ...
  return "channelsFirst" === i ? d = [c, P, O, M, B] : "channelsLast" === i && (d = [c, O, M, B, P]), {
    batchSize: c,
    dataFormat: i,
    inDepth: l,
    inHeight: h,
...
function Ao(t, e, n) {
  ...
  if (!B(t.dtype, e)) return Ft.makeTensorFromDataId(t.dataId, t.shape, e);
...
var No = Object.freeze({
  ...
  eitherStridesOrDilationsAreOne: ko,
  convertConv2DDataFormat: So
});
exports.backend_util = No;
...
function Lo(t, e, n, r, o, a) {
  for (var i = Array.from(e).map(function (t, e) {
    ...
    return t.score > o;
  }).sort(Vo), s = a > 0 ? -.5 / a : 0, u = []; u.length < n && i.length > 0;) {
    var c = i.pop(),
        l = c.score,
        h = c.boxIndex,
        f = c.suppressBeginIndex;
    if (l < o) break;

    for (var p = !1, d = u.length - 1; d >= f; --d) {
      var v = Wo(t, h, u[d]);
      ...
      if (c.score = c.score * Uo(r, s, v), c.score <= o) break;
    }

    c.suppressBeginIndex = u.length, p || (c.score === l ? u.push(h) : c.score > o && Bo(i, c, Vo));
  }
...
function Ho(t, e, n, r, o) {
  for (var a = e[e.length - 1], i = [t.length / a, a], s = i[0], u = i[1], c = F(n, s * r), l = F("int32", s * r), h = 0; h < s; h++) {
    for (var f = h * u, p = t.subarray(f, f + u), d = [], v = 0; v < p.length; v++) d.push({
      value: p[v],
      index: v
    });
    ...
    for (v = 0; v < r; v++) m[v] = d[v].value, y[v] = d[v].index;
  }
...
function ea(t, e, n, r) {
  ...
  t.forEach(function (t) {
    var e = C(t.shapeInfo.logicalShape);
    ...
    return function (t, e, n) {
      ...
      o.length <= a.length && (r += n ? function (t, e) {
        var n,
            ...
            u = fo(t.shapeInfo.logicalShape, e.logicalShape),
            c = la(s),
            l = s - i,
            h = ["x", "y", "z", "w", "u", "v"];
        ...
        var p = "return outputValue;",
            d = 1 === C(t.shapeInfo.logicalShape),
            v = 1 === C(e.logicalShape);

        if (1 !== i || d || v) {
          if (d && !v) p = 1 === s ? "\n        return vec4(outputValue.x, outputValue.x, 0., 0.);\n      " : "\n        return vec4(outputValue.x);\n      ";else if (u.length) {
            var g = i - 2,
                m = i - 1;
            u.indexOf(g) > -1 && u.indexOf(m) > -1 ? p = "return vec4(outputValue.x);" : u.indexOf(g) > -1 ? p = "return vec4(outputValue.x, outputValue.y, outputValue.x, outputValue.y);" : u.indexOf(m) > -1 && (p = "return vec4(outputValue.xx, outputValue.zz);");
          }
        ...
        if (!t.shapeInfo.isUniform && s === u && null == t.shapeInfo.flatOffset && E(i, a)) return "\n      float " + o + "() {\n        return sampleTexture(" + n + ", resultUV);\n      }\n    ";
        var c,
            l = la(u),
            h = fo(t.shapeInfo.logicalShape, e.logicalShape),
            f = u - s,
            p = ["x", "y", "z", "w", "u", "v"];
  ...
  switch (e.length) {
    ...
    case 4:
      return function (t) {
        ...
        if (u.length < e.length) {
          var l = ha(t, u);
          return "\n      " + na(l) + "\n      float " + r + "(int row, int col, int depth, int depth2) {\n        return " + r + "(" + fa(["row", "col", "depth", "depth2"], c) + ");\n      }\n    ";
        }
    ...
    case 5:
      return function (t) {
        ...
        if (c.length < e.length) {
          var h = ha(t, c);
          return "\n      " + na(h) + "\n      float " + r + "(int row, int col, int depth, int depth2, int depth3) {\n        return " + r + "(" + fa(["row", "col", "depth", "depth2", "depth3"], l) + ");\n      }\n    ";
        }
    ...
    case 6:
      return function (t) {
        ...
        if (a.length < e.length) {
          var s = ha(t, a);
          return "\n      " + na(s) + "\n      float " + r + "(int row, int col, int depth,\n                    int depth2, int depth3, int depth4) {\n        return " + r + "(" + fa(["row", "col", "depth", "depth2", "depth3", "depth4"], i) + ");\n      }\n    ";
        }
...
function ra(t) {
  ...
  switch (t.shapeInfo.logicalShape.length) {
    case 0:
      return e = t.name, n = "get" + e.charAt(0).toUpperCase() + e.slice(1), r = Qo(), "\n    vec4 " + n + "() {\n      return " + r.texture2D + "(" + e + ", halfCR);\n    }\n  ";
    ...
    default:
      return function (t) {
        for (var e = t.shapeInfo.logicalShape, n = e.length, r = t.name, o = "get" + r.charAt(0).toUpperCase() + r.slice(1), a = t.shapeInfo.texShape, i = [Math.ceil(a[0] / 2), Math.ceil(a[1] / 2)], s = i[0], u = i[1], c = Math.ceil(e[n - 1] / 2), l = c * Math.ceil(e[n - 2] / 2), h = "int b, int row, int col", f = "b * " + l + " + (row / 2) * " + c + " + (col / 2)", p = 2; p < n - 1; p++) h = "int b" + p + ", " + h, l *= e[n - p - 1], f = "b" + p + " * " + l + " + " + f;
...
var pa = function (t, e, n, r) {
  this.variableNames = ["A"], this.packedInputs = !0, this.packedOutput = !0, y(t.length > 2, function () {
  ...
  var p = ["x", "y", "z", "w", "u", "v"].slice(0, s),
    ...
    return "int " + t;
      ...
      g = Yo("sourceLocR", s - 1).concat("inIdx.r"),
      m = Yo("sourceLocG", s - 1).concat("inIdx.g"),
      x = Yo("sourceLocB", s - 1).concat("inIdx.b"),
      b = Yo("sourceLocA", s - 1).concat("inIdx.a"),
  ...
  this.userCode = "\n      const ivec3 pads = ivec3(" + p + ", " + d + ", " + v + ");\n      const float avgMultiplier = float(" + g + ");\n\n      void main() {\n        ivec5 coords = getOutputCoords();\n        int batch = coords.x;\n        int ch = coords.u;\n\n        ivec3 dyCorner = ivec3(coords.y, coords.z, coords.w) - pads;\n        int dyDCorner = dyCorner.x;\n        int dyRCorner = dyCorner.y;\n        int dyCCorner = dyCorner.z;\n\n        // Convolve dy(?, ?, ?, d) with pos mask(:, :, :, ch) to get\n        // dx(xD, xR, xC, ch).\n        // ? = to be determined. : = across all values in that axis.\n        float dotProd = 0.0;\n\n        for (int wD = 0; wD < " + l + ";\n            wD += " + s + ") {\n          float dyD = float(dyDCorner + wD) / " + o + ".0;\n\n          if (dyD < 0.0 || dyD >= " + t.outDepth + ".0 || fract(dyD) > 0.0) {\n            continue;\n          }\n          int idyD = int(dyD);\n\n          for (int wR = 0; wR < " + h + ";\n              wR += " + u + ") {\n            float dyR = float(dyRCorner + wR) / " + a + ".0;\n\n            if (dyR < 0.0 || dyR >= " + t.outHeight + ".0 ||\n                fract(dyR) > 0.0) {\n              continue;\n            }\n            int idyR = int(dyR);\n\n            for (int wC = 0; wC < " + f + ";\n                wC += " + c + ") {\n              float dyC = float(dyCCorner + wC) / " + i + ".0;\n\n              if (dyC < 0.0 || dyC >= " + t.outWidth + ".0 ||\n                  fract(dyC) > 0.0) {\n                continue;\n              }\n              int idyC = int(dyC);\n\n              float dyValue = getDy(batch, idyD, idyR, idyC, ch);\n\n              dotProd += dyValue * avgMultiplier;\n            }\n          }\n        }\n        setOutput(dotProd);\n      }\n    ";
    ...
    ga = function (t, e, n, r, o, a) {
  this.outputShape = [], this.variableNames = ["x", "mean", "variance"], vo(t, e), vo(t, n);
  var i = "0.0";
  null != r && (vo(t, r), this.variableNames.push("offset"), i = "getOffsetAtOutCoords()");
  var s = "1.0";
  ...
  null != o && (vo(t, o), this.variableNames.push("scale"), s = "getScaleAtOutCoords()"), this.outputShape = t, this.userCode = "\n      void main() {\n        vec4 offset = " + i + ";\n        vec4 scale = " + s + ";\n\n        vec4 x = getXAtOutCoords();\n        vec4 mean = getMeanAtOutCoords();\n        vec4 variance = getVarianceAtOutCoords();\n\n        vec4 inv = scale * inversesqrt(variance + vec4(" + a + "));\n\n        setOutput((x - mean) * inv + offset);\n      }\n    ";
    ...
    ya = "return areal * breal - aimag * bimag;",
    xa = "return areal * bimag + aimag * breal;",
    ba = function (t, e, n) {
  this.variableNames = ["AReal", "AImag", "BReal", "BImag"], this.outputShape = vo(e, n), this.userCode = "\n      float binaryOpComplex(\n          float areal, float aimag, float breal, float bimag) {\n        " + t + "\n      }\n\n      void main() {\n        float areal = getARealAtOutCoords();\n        float aimag = getAImagAtOutCoords();\n        float breal = getBRealAtOutCoords();\n        float bimag = getBImagAtOutCoords();\n        setOutput(binaryOpComplex(areal, aimag, breal, bimag));\n      }\n    ";
},
    wa = "return a + b;",
    Ca = "return a - b;",
    Ea = "return a * b;",
    Ra = "return (a < 0.) ? b * a : a;",
    Ia = function (t, e, n) {
  this.variableNames = ["A", "B"], this.outputShape = vo(e, n), this.userCode = "\n      float binaryOperation(float a, float b) {\n        " + t + "\n      }\n\n      void main() {\n        float a = getAAtOutCoords();\n        float b = getBAtOutCoords();\n        setOutput(binaryOperation(a, b));\n      }\n    ";
},
  ...
  var o = this.outputShape.length,
      a = "";
  if (r) if (0 === o || 1 === C(this.outputShape)) a = "\n          result.y = 0.;\n          result.z = 0.;\n          result.w = 0.;\n        ";else if (a = "\n          " + la(o) + " coords = getOutputCoords();\n        ", 1 === o) a += "\n            result.y = (coords + 1) >= " + this.outputShape[0] + " ? 0. : result.y;\n            result.z = 0.;\n            result.w = 0.;\n          ";else {
    var i = Yo("coords", o);
...
var Oa = function (t) {
  ...
  for (var o = t.inHeight, a = t.inWidth, i = t.padInfo.top, s = t.padInfo.left, u = t.strideHeight, c = t.strideWidth, l = t.dilationHeight, h = t.dilationWidth, f = t.filterHeight, p = t.filterWidth, d = p, v = "int xR; int xC; int xCOffset;", m = 0; m < f; m++) for (var y = 0; y < p; y++) v += "\n          vec4 xTexelR" + m + "C" + 2 * y + " = vec4(0.);\n          vec4 wR" + m + "C" + y + " = vec4(0.);\n          vec4 xR" + m + "C" + y + " = vec4(0.);";

  for (m = 0; m < f; m++) for (var x = 0; x < d; x++) {
    if (v += "\n          xR = xRCorner + " + m * l + ";\n          xC = xCCorner + " + (y = 2 * x) * h + ";\n        ", 1 === c) {
  ...
  var f = "bilinear" === r ? 1 : 0,
      ...
      d = p[0],
      v = p[1],
      g = l > 1 ? ["" + (i - 1) / (l - 1), "(y2-y1) * height_ratio", "y1*" + d + " + float(y)*(height_scale)"] : ["0.0", "0.0", "0.5 * (y1+y2) * " + d],
      m = g[0],
      y = g[1],
      x = g[2],
...
var ja = function (t) {
  this.variableNames = ["A"], this.packedInputs = !1, this.packedOutput = !0, this.outPackingScheme = Mt.DENSE;
  var e = Gt(t),
      n = Qo();
  this.outputShape = t, this.userCode = "\n      ivec3 outCoordsFromFlatIndex(int index) {\n        " + Jo(["r", "c", "d"], t) + "\n        return ivec3(r, c, d);\n      }\n\n      void main() {\n        ivec2 resTexRC = ivec2(resultUV.yx *\n          vec2(" + e[0] + ", " + e[1] + "));\n        int index = 4 * (resTexRC.x * " + e[1] + " + resTexRC.y);\n\n        vec4 result = vec4(0.);\n\n        for (int i=0; i<4; i++) {\n          int flatIndex = index + i;\n          ivec3 rc = outCoordsFromFlatIndex(flatIndex);\n          result[i] = getA(rc.x, rc.y, rc.z);\n        }\n\n        " + n.output + " = result;\n      }\n    ";
},
    Xa = function (t) {
  this.variableNames = ["A"], this.packedInputs = !0, this.packedOutput = !0, this.outPackingScheme = Mt.DENSE;
  var e = Gt(t),
      n = Qo();
  ...
  this.outputShape = t, this.userCode = "\n      " + ta + "\n\n      void main() {\n        float x = getAAtOutCoords();\n        " + e.output + " = encode_float(x);\n      }\n    ";
    ...
    Ja = function (t) {
  this.variableNames = ["A"], this.packedInputs = !0, this.packedOutput = !1, this.outTexUsage = Bt.DOWNLOAD;
  var e = Qo();
  ...
  this.userCode = "\n      " + Zo(t) + "\n\n      void main() {\n        ivec3 coords = getOutputCoords();\n\n        vec4 result = vec4(0.);\n        int flatIndex, r, c, offset;\n        ivec3 localCoords;\n        vec2 uv;\n        vec4 values;\n\n        " + i + "\n\n        " + r.output + " = " + s + ";\n      }\n    ";
    ...
    ei = "return real * expR - imag * expI;",
    ni = "return real * expI + imag * expR;",
    ri = function (t, e, n) {
...
function ci(t, e) {
  return se(t, e, new Uint16Array([0, 1, 2, 2, 1, 3]));
}
...
function hi(t, e, n, r, o) {
  var a = zt(n, r);
  return li(t, e, a[0], a[1], o.internalFormatFloat, o.textureFormatFloat, t.FLOAT);
}

function fi(t, e, n, r, o) {
  var a = zt(n, r);
  return li(t, e, a[0], a[1], o.internalFormatHalfFloat, o.textureFormatFloat, o.textureTypeHalfFloat);
}

function pi(t, e, n, r, o) {
  var a = zt(n, r);
  return li(t, e, a[0], a[1], t.RGBA, t.RGBA, t.UNSIGNED_BYTE);
}

function di(t, e, n, r, o) {
  var a = Ht(n, r);
  return li(t, e, a[0], a[1], o.internalFormatPackedFloat, t.RGBA, t.FLOAT);
}

function vi(t, e, n, r, o) {
  var a = Ht(n, r);
  return li(t, e, a[0], a[1], o.internalFormatPackedHalfFloat, t.RGBA, o.textureTypeHalfFloat);
}
...
function mi(t, e, n, r, o, a, i) {
  ...
  Kt(t, e, function () {
    return t.bindTexture(t.TEXTURE_2D, n);
  }), a instanceof Uint8Array ? (s = new Uint8Array(r * o * 4), u = t.UNSIGNED_BYTE, c = t.RGBA) : (s = new Float32Array(r * o * 4), u = t.FLOAT, c = i.internalFormatPackedFloat), s.set(a), Kt(t, e, function () {
...
var Ri = Object.freeze({
  ...
  createIndexBuffer: ci,
  createFloat32MatrixTexture: hi,
  createFloat16MatrixTexture: fi,
  createUnsignedBytesMatrixTexture: pi,
  createPackedMatrixTexture: di,
  createFloat16PackedMatrixTexture: vi,
  bindVertexProgramAttributeStreams: gi,
  uploadDenseMatrixToTexture: mi,
  uploadPixelDataToTexture: yi,
  createBufferFromOutputTexture: xi,
  downloadFloat32MatrixFromBuffer: bi,
  downloadByteEncodedFloatMatrixFromOutputTexture: wi,
  downloadPackedMatrixFromBuffer: Ci,
  downloadMatrixFromPackedOutputTexture: Ei
}),
    Ii = function () {
  function t(t) {
    this.outputTexture = null, this.program = null, this.disposed = !1, this.vertexAttrsAreBound = !1, this.itemsToPoll = [];
    var e = i().getNumber("WEBGL_VERSION");
    null != t ? (this.gl = t, Ut(e, t)) : this.gl = Vt(e);
    var n = "WEBGL_color_buffer_float";

    if (1 === i().getNumber("WEBGL_VERSION")) {
      if (this.textureFloatExtension = Qt(this.gl, this.debug, "OES_texture_float"), Ne(this.gl, "OES_texture_half_float")) this.textureHalfFloatExtension = Qt(this.gl, this.debug, "OES_texture_half_float");else if (i().get("WEBGL_FORCE_F16_TEXTURES")) throw new Error("GL context does not support half float textures, yet the environment flag WEBGL_FORCE_F16_TEXTURES is set to true.");
      if (this.colorBufferFloatExtension = this.gl.getExtension(n), Ne(this.gl, "EXT_color_buffer_half_float")) this.colorBufferHalfFloatExtension = Qt(this.gl, this.debug, "EXT_color_buffer_half_float");else if (i().get("WEBGL_FORCE_F16_TEXTURES")) throw new Error("GL context does not support color renderable half floats, yet the environment flag WEBGL_FORCE_F16_TEXTURES is set to true.");
    } else if (n = "EXT_color_buffer_float", Ne(this.gl, n)) this.colorBufferFloatExtension = this.gl.getExtension(n);else {
    ...
    this.vertexBuffer = ui(this.gl, this.debug), this.indexBuffer = ci(this.gl, this.debug), this.framebuffer = le(this.gl, this.debug), this.textureConfig = qt(this.gl, this.textureHalfFloatExtension);
  }
  ...
  return Object.defineProperty(t.prototype, "debug", {
    ...
    this.throwIfDisposed(), yi(this.gl, this.debug, t, e);
  }, t.prototype.uploadDenseMatrixToTexture = function (t, e, n, r) {
    this.throwIfDisposed(), mi(this.gl, this.debug, t, e, n, r, this.textureConfig);
    ...
    var e = this;
    this.throwIfDisposed(), this.outputTexture === t && (me(this.gl, this.debug, this.framebuffer), this.outputTexture = null), Kt(this.gl, this.debug, function () {
    ...
    return this.downloadMatrixDriver(t, function () {
      return wi(r.gl, r.debug, e, n, r.textureConfig);
    });
  }, t.prototype.downloadPackedMatrixFromBuffer = function (t, e, n, r, o, a) {
    return Ci(this.gl, t, 0, 0, 0, o, a, this.textureConfig);
    ...
    var r = xi(this.gl, this.debug, e, n, this.textureConfig);
    ...
    }), oe(e, this.debug, o), this.debug && ae(e, this.debug, o), this.vertexAttrsAreBound || (this.setProgram(o), this.vertexAttrsAreBound = gi(e, this.debug, this.program, this.vertexBuffer)), o;
    ...
    return null == this.disjointQueryTimerExtension && (this.disjointQueryTimerExtension = Qt(this.gl, this.debug, 2 === i().getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION") ? "EXT_disjoint_timer_query_webgl2" : "EXT_disjoint_timer_query")), this.disjointQueryTimerExtension;
    ...
    this.itemsToPoll.push({
      isDoneFn: t,
      resolveFn: e
    }), this.itemsToPoll.length > 1 || A(function () {
      return n.pollItems(), 0 === n.itemsToPoll.length;
    });
  }, t.prototype.bindTextureToFrameBuffer = function (t) {
    this.throwIfDisposed(), ge(this.gl, this.debug, t, this.framebuffer), this.debug && ye(this.gl);
  }, t.prototype.unbindTextureToFrameBuffer = function () {
    null != this.outputTexture ? (ge(this.gl, this.debug, this.outputTexture, this.framebuffer), this.debug && ye(this.gl)) : me(this.gl, this.debug, this.framebuffer);
    ...
    this.throwIfDisposed();
    var r = this.gl;
    ge(r, this.debug, t, this.framebuffer), this.debug && ye(r), this.outputTexture = t, Kt(r, this.debug, function () {
...
function ki(t, e) {
  ...
  t.forEach(function (t, n) {
    var r = t.logicalShape,
        o = e[n],
        a = o.shape;
    if (!E(r, a)) throw Error("Binary was compiled with different shapes than the current args. Shapes " + r + " and " + a + " must match");

    if (!t.isUniform || !o.isUniform) {
      var i = t.texShape,
          s = o.isUniform ? null : o.texData.texShape;
      if (!E(i, s)) throw Error("Binary was compiled with different texture shapes than the current args. Shape " + i + " and " + s + " must match");
    }
  });
}
...
var Si = function (t, e, n) {
  ...
  for (var r = n.filterWidth, o = n.inChannels, a = n.strideWidth, i = n.strideHeight, s = n.padInfo, u = n.outWidth, c = n.dilationWidth, l = n.dilationHeight, h = n.dataFormat, f = s.left, p = s.top, d = o * r, v = Qo(), g = "channelsLast" === h, m = g ? 0 : 1, y = g ? 1 : 2, x = "", b = 0; b <= 1; b++) for (var w = 0; w <= 1; w++) x += "\n          blockIndex = rc.y + " + w + ";\n          pos = rc.x + " + b + ";\n\n          if(blockIndex < " + t[1] + " && pos < " + t[0] + ") {\n            offsetY = int(blockIndex / (" + u + ")) * " + i + " - " + p + ";\n            d0 = offsetY + " + l + " * (pos / " + d + ");\n\n            if(d0 < " + e[m] + " && d0 >= 0) {\n\n              offsetX = int(mod(float(blockIndex), " + u + ".) * " + a + ". - " + f + ".);\n              d1 = offsetX + " + c + " * (int(mod(float(pos), " + d + ".) / " + o + ".));\n\n              if(d1 < " + e[y] + " && d1 >= 0) {\n\n                ch = int(mod(float(pos), " + o + ".));\n\n                if (" + g + ") {\n                  innerDims = vec2(d1, ch);\n                  result[" + (2 * b + w) + "] = getChannel(\n                    getA(d0, int(innerDims.x),\n                    int(innerDims.y)), innerDims);\n                } else {\n                  innerDims = vec2(d0, d1);\n                  result[" + (2 * b + w) + "] = getChannel(\n                    getA(ch, int(innerDims.x),\n                    int(innerDims.y)), innerDims);\n                }\n              }\n            }\n          }\n        ";

  this.userCode = "\n      void main() {\n        ivec2 rc = getOutputCoords();\n\n        vec4 result = vec4(0);\n\n        int blockIndex, pos, offsetY, d0, offsetX, d1, ch;\n        vec2 innerDims;\n\n        " + x + "\n\n        " + v.output + " = result;\n      }\n    ";
},
    Ai = function (t, e, n, r, o) {
...
var Pi = function (t, e, n) {
  ...
  for (var r = t.length, o = la(r), a = e.map(function (t) {
    return t[0];
  }).join(","), i = e.map(function (e, n) {
    return e[0] + t[n];
  }).join(","), s = Yo("rc", r), u = Yo("source", r), c = s[r - 1] + " < " + this.outputShape[r - 1], l = 1 === r ? "source" : "vec2(" + u.slice(-2).join() + ")", h = [o + " rc = outputLoc;", s[r - 1] + " += 1;\n       if(" + c + ") {\n      ", 1 === r ? "" : "}\n       rc = outputLoc;\n       " + s[r - 2] + " += 1;\n       if(" + s[r - 2] + " < " + this.outputShape[r - 2] + ") {", 1 === r ? "" : "  " + s[r - 1] + " += 1;\n         if(" + c + ") {"], f = 1 === r ? "rc < start || rc >= end" : "any(lessThan(rc, start)) || any(greaterThanEqual(rc, end))", p = "", d = 0, v = 1 === r ? 2 : 4; d < v; d++) p += "\n        " + h[d] + "\n        if (" + f + ") {\n          result[" + d + "] = float(" + n + ");\n        } else {\n          " + o + " source = rc - start;\n          result[" + d + "] = getChannel(getX(" + u.join() + "), " + l + ");\n        }\n      ";
...
var Gi = function (t, e, n) {
  ...
  function t(t) {
    ...
    var e,
      ...
      if (t <= 6) return ts.slice(0, t).map(function (t) {
        return "sourceLoc." + t;
      }).join(",");
    ...
    e = "\n        " + n + " sourceLoc;\n        " + n + " coords = getOutputCoords();\n        " + t.map(function (t, e) {
      return "sourceLoc." + ts[e] + " = start[" + e + "] + coords." + ts[e] + ";";
...
var es = function () {
  function t(t) {
    ...
    var e = la(this.rank),
        n = Yo("coords", this.rank),
        r = Yo("sourceLoc", this.rank),
...
function os(t, e) {
  if (t === Bt.UPLOAD) return Pt.PACKED_2X2_FLOAT32;
  if (t === Bt.RENDER || null == t) return function (t) {
    return i().getBool("WEBGL_RENDER_FLOAT32_ENABLED") ? t ? Pt.PACKED_2X2_FLOAT32 : Pt.UNPACKED_FLOAT32 : t ? Pt.PACKED_2X2_FLOAT16 : Pt.UNPACKED_FLOAT16;
  }(e);
  if (t === Bt.DOWNLOAD || t === Bt.PIXELS) return Pt.PACKED_4X1_UNSIGNED_BYTE;
...
var us = function (t, e) {
  ...
  this.userCode = "\n    void main() {\n      " + o + " rc = getOutputCoords();\n      vec4 result = vec4(0.);\n      result[0] = " + c + ";\n      if(" + u + ") {\n        result[1] = " + c + ";\n      }\n      --" + a[this.rank - 1] + ";\n      if(++" + a[this.rank - 2] + " < " + n[this.rank - 2] + ") {\n        result[2] = " + c + ";\n        if(" + u + ") {\n          result[3] = " + c + ";\n        }\n      }\n      setOutput(result);\n    }\n    ";
    ...
    cs = 1.7580993408473768,
    ls = 1.0507009873554805,
    hs = function (t, e) {
  this.variableNames = ["A"], this.outputShape = t, this.userCode = "\n      float unaryOperation(float x) {\n        " + e + "\n      }\n\n      void main() {\n        float x = getAAtOutCoords();\n        float y = unaryOperation(x);\n\n        setOutput(y);\n      }\n    ";
},
    fs = "if (isnan(x)) return x;",
    ps = "return x;",
    ds = "return abs(x);",
    vs = fs + "\n  return (x < 0.0) ? 0.0 : x;\n",
    gs = fs + "\n  return (x < 0.0) ? 0.0 : min(6.0, x);\n",
    ms = "return (x >= 0.0) ? x : (exp(x) - 1.0);",
...
var xs = "return -x;",
    ...
    Ss = fs + "\n  if (abs(x) > 1.) {\n    return NAN;\n  }\n  return acos(x);\n",
    As = fs + "\n  return atan(x);\n",
    Ds = fs + "return log(x + sqrt(x * x + 1.0));",
...
function Us(t, e) {
  if (void 0 === e && (e = !1), "linear" === t) return e ? _s : ps;
  if ("relu" === t) return e ? Os : vs;
  if ("elu" === t) return e ? Bs : ms;
  if ("relu6" === t) return e ? Ms : gs;
  if ("prelu" === t) return e ? ka : Ra;
...
var zs = function (t) {
  function o(e) {
    ...
    if (null == e) {
      var o = Vt(i().getNumber("WEBGL_VERSION"));
      r.binaryCache = (n = i().getNumber("WEBGL_VERSION")) in Ws ? Ws[n] : (Ws[n] = {}, Ws[n]), r.gpgpu = new Ii(o), r.canvas = o.canvas, r.gpgpuCreatedLocally = !0;
    } else r.gpgpu = e, r.binaryCache = {}, r.gpgpuCreatedLocally = !1, r.canvas = e.gl.canvas;

    return r.textureManager = new rs(r.gpgpu), r.numMBBeforeWarning = null == i().global.screen ? 1024 : i().global.screen.height * i().global.screen.width * window.devicePixelRatio * Vs / 1024 / 1024, r.texData = new co(r, Ft), r;
  }
  ...
  return e(o, t), o.prototype.numDataIds = function () {
    ...
    (p && (h = Q()), "complex64" === r) ? f = Fo(o.real.dataSync(), o.imag.dataSync()) : f = this.getValuesFromTexture(t);
    return p && (this.downloadWaitMs += Q() - h), this.convertAndCacheOnCPU(t, f);
  }, o.prototype.read = function (t) {
    return n(this, void 0, void 0, function () {
      var e, n, o, a, s, u, c, l, h, f, p, d, v, g, m, y, x, b, w, E, R, I;
      return r(this, function (r) {
        switch (r.label) {
          case 0:
            ...
            if (n = this.texData.get(t), o = n.values, a = n.shape, s = n.slice, u = n.dtype, c = n.complexTensors, l = n.isPacked, null != s) return h = void 0, h = l ? new Ps(a, Fs) : new hs(a, Fs), f = this.runWebGLProgram(h, [{
              dataId: t,
              shape: a,
              dtype: u
            }], u), p = this.read(f.dataId), this.disposeData(f.dataId), [2, p];
            ...
            return d = null, "complex64" !== u && i().get("WEBGL_BUFFER_SUPPORTED") && (v = this.decode(t), g = this.texData.get(v.dataId), d = (I = this.gpgpu).createBufferFromTexture.apply(I, [g.texture].concat(Gt(a)))), this.pendingRead.set(t, []), "complex64" === u ? [3, 2] : [4, this.gpgpu.createAndWaitForFence()];
          ...
          case 3:
            return y = r.sent(), x = y[0], b = y[1], m = Fo(x, b), [3, 5];

          case 4:
            null == d ? m = this.getValuesFromTexture(t) : (w = C(a), m = this.gpgpu.downloadFloat32MatrixFromBuffer(d, w)), r.label = 5;

          case 5:
            return null != v && this.disposeData(v.dataId), E = this.convertAndCacheOnCPU(t, m), R = this.pendingRead.get(t), this.pendingRead.delete(t), R.forEach(function (t) {
              return t(E);
    ...
    if (i().getBool("WEBGL_DOWNLOAD_FLOAT_ENABLED")) {
      var u = this.decode(t),
          ...
          l = (e = this.gpgpu).downloadMatrixFromPackedTexture.apply(e, [c.texture].concat(Gt(r))).subarray(0, s);
      return this.disposeData(u.dataId), l;
    }

    var h = i().getBool("WEBGL_PACK") && !0 === a,
        f = h ? Re(r) : r,
        p = h ? new Ja(f) : new Qa(f),
    ...
    return n(this, void 0, void 0, function () {
      ...
      return r(this, function (r) {
        switch (r.label) {
          case 0:
            return e = this.activeTimers, n = [], o = !1, null == this.programTimersStack ? (this.programTimersStack = n, o = !0) : this.activeTimers.push(n), this.activeTimers = n, t(), a = w(this.activeTimers.map(function (t) {
              return t.query;
            })).filter(function (t) {
              return null != t;
            }), i = w(this.activeTimers.map(function (t) {
              return t.name;
            })).filter(function (t) {
              return null != t;
    ...
    return i().getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION") > 0 ? (this.gpgpu.endQuery(), t) : (t.endMs = Q(), t);
    ...
    return i().getBool("WEBGL_CPU_FORWARD") ? (null == this.cpuBackend && (this.cpuBackend = Ft.findBackend("cpu")), this.cpuBackend) : null;
    ...
    if (0 === C(n)) return kn([], n, t.dtype);
    var r = this.texData.get(t.dataId).isPacked,
        o = Qr(t.shape, e, n);

    if (r || !o) {
      var a = i().getBool("WEBGL_PACK_ARRAY_OPERATIONS") ? new es(n) : new Zi(n),
    ...
    var n = i().getBool("WEBGL_PACK_ARRAY_OPERATIONS") ? new $i(t.shape, e) : new Xi(t.shape, e);
    ...
    var c = wn(t.map(function (t) {
      return t.shape;
        ...
        l = t.map(function (t) {
      return t.as2D(-1, C(t.shape.slice(e)));
    }),
        h = new Na(l.map(function (t) {
      return t.shape;
    }));
    ...
    if (i().getBool("WEBGL_PACK_UNARY_OPERATIONS")) return this.packedUnaryOp(t, xs, t.dtype);
    var e = new hs(t.shape, xs);
    ...
    var h = Et(t.dtype, e.dtype),
        f = new _i(t.shape, [s, o, a], n, r);
    ...
    var e = t.a,
        ...
        l = e.shape[0],
        h = Et(e.dtype, n.dtype),
        f = null != a,
        p = null != s,
        d = i ? Us(i, !0) : null,
        v = new _i(e.shape, [l, u, c], r, o, f, d, p),
        g = [e, n];
    ...
    if ("complex64" === t.dtype) {
      var n = this.texData.get(t.dataId),
          ...
          o = new ba(ya, t.shape, e.shape),
          a = new ba(xa, t.shape, e.shape),
    ...
    if (i().getBool("WEBGL_PACK_BINARY_OPERATIONS")) return this.packedBinaryOp(t, e, Ea, t.dtype);
    var h = new Ia(Ea, t.shape, e.shape);
    ...
    if (null != o && (c = o.shape, s.push(o)), i().getBool("WEBGL_PACK_NORMALIZATION")) {
      var l = new ma(t.shape, e.shape, n.shape, u, c, r);
      return this.compileAndRun(l, s);
    }

    var h = new ga(t.shape, e.shape, n.shape, u, c, r);
    return this.compileAndRun(h, s);
  }, o.prototype.localResponseNormalization4D = function (t, e, n, r, o) {
    var a = i().getBool("WEBGL_PACK_NORMALIZATION") ? new Ti(t.shape, e, n, r, o) : new Ai(t.shape, e, n, r, o);
    return this.compileAndRun(a, [t]);
    ...
    var a = t.shape[0],
      ...
      for (t <= zr ? (n = t, r = !0) : n = q(t, Math.floor(Math.sqrt(t))); !r;) n > e || n === t ? r = !0 : n = q(t, n + 1);
    ...
    return c.shape[1] === o ? c : (n = Un(0, o).tile([i / s]), this.segOpCompute(c, e, n, r, o));
  }, o.prototype.argMinMaxReduce = function (t, e, n) {
    var r = [e];

    if (gn("arg" + n.charAt(0).toUpperCase() + n.slice(1), r, t.rank), !i().getBool("WEBGL_PACK_REDUCE") || t.rank <= 2) {
      var o = dn(t.shape, r),
          a = o[0],
          s = C(o[1]),
          u = t.as2D(-1, s);
    ...
    var n = new Ia("return float(a == b);", t.shape, e.shape);
    ...
    var e = new hs(t.shape, "return float(!(x >= 1.0));");
    return this.compileAndRun(e, [t]);
  }, o.prototype.logicalAnd = function (t, e) {
    if (i().getBool("WEBGL_PACK_BINARY_OPERATIONS")) return this.packedBinaryOp(t, e, "\n  return vec4(\n    vec4(greaterThanEqual(a, vec4(1.0))) *\n    vec4(greaterThanEqual(b, vec4(1.0))));\n", "bool");
    var n = new Ia("return float(a >= 1.0 && b >= 1.0);", t.shape, e.shape);
    return this.compileAndRun(n, [t, e], "bool");
    ...
    var r = new Ji(t.rank, e.shape, e.rank);
    return this.compileAndRun(r, [t, e, n], Et(e.dtype, n.dtype));
  }, o.prototype.where = function (t) {
    sn("tf.where() in webgl locks the UI thread. Call tf.whereAsync() instead");
    var e = t.dataSync();
    return qo(t.shape, e);
    ...
    var n = i().getBool("WEBGL_PACK_BINARY_OPERATIONS") ? new Sa("return (a - b) * (a - b);", t.shape, e.shape) : new Ia("return (a - b) * (a - b);", t.shape, e.shape);
    return this.compileAndRun(n, [t, e]);
    ...
    if ("complex64" === t.dtype && "complex64" === e.dtype) return this.complexSeparableBinaryOp(t, e, wa);
    if (this.shouldExecuteOnCPU([t, e])) return this.cpuBackend.add(t, e);
    var n = Et(t.dtype, e.dtype);
    if (i().getBool("WEBGL_PACK_BINARY_OPERATIONS")) return this.packedBinaryOp(t, e, wa, n);
    var r = new Ia(wa, t.shape, e.shape);
    return this.compileAndRun(r, [t, e], n);
  }, o.prototype.packedUnaryOp = function (t, e, n) {
    var r = new Ps(t.shape, e);
    return this.compileAndRun(r, [t], n);
  }, o.prototype.packedBinaryOp = function (t, e, n, r, o) {
    void 0 === o && (o = !1);
    var a = new Sa(n, t.shape, e.shape, o);
    ...
    var r = this,
      ...
      var a = o[0],
          ...
          c = new Ia(n, t.shape, e.shape);
      return r.compileAndRun(c, [s, u], Et(a.dtype, i.dtype));
    }),
        s = i[0],
        u = i[1],
        c = this.complex(s, u);
    ...
    var o = t.map(function (t) {
      ...
      return t.shape;
        ...
        s = i().getBool("WEBGL_PACK") ? new jo(t[0].shape, a) : new Ko(t[0].shape, a);
    ...
    var n = Et(t.dtype, e.dtype);
    if (i().getBool("WEBGL_PACK_BINARY_OPERATIONS")) return this.packedBinaryOp(t, e, Ca, t.dtype);
    var r = new Ia(Ca, t.shape, e.shape);
    return this.compileAndRun(r, [t, e], n);
    ...
    if (i().getBool("WEBGL_PACK_UNARY_OPERATIONS")) return this.packedUnaryOp(t, Cs, t.dtype);
    var e = new hs(t.shape, Cs);
    return this.compileAndRun(e, [t]);
    ...
    var e = new hs(t.shape, "if (x < 0.0) return NAN;\n  return log(x);");
    return this.compileAndRun(e, [t]);
  }, o.prototype.log1p = function (t) {
    var e = new hs(t.shape, "return log(1.0 + x);");
    return this.compileAndRun(e, [t]);
  }, o.prototype.sqrt = function (t) {
    var e = new hs(t.shape, "return sqrt(x);");
    return this.compileAndRun(e, [t]);
  }, o.prototype.rsqrt = function (t) {
    if (this.shouldExecuteOnCPU([t])) return this.cpuBackend.rsqrt(t);
    var e = new hs(t.shape, "return inversesqrt(x);");
    return this.compileAndRun(e, [t]);
  }, o.prototype.reciprocal = function (t) {
    var e = new hs(t.shape, "return 1.0 / x;");
    return this.compileAndRun(e, [t]);
  }, o.prototype.relu = function (t) {
    var e;
    return e = i().getBool("WEBGL_PACK") ? new Ps(t.shape, Os) : new hs(t.shape, vs), this.compileAndRun(e, [t]);
  }, o.prototype.relu6 = function (t) {
    var e;
    return e = i().getBool("WEBGL_PACK") ? new Ps(t.shape, Ms) : new hs(t.shape, gs), this.compileAndRun(e, [t]);
  }, o.prototype.prelu = function (t, e) {
    var n = i().getBool("WEBGL_PACK_BINARY_OPERATIONS") ? new Sa(ka, t.shape, e.shape) : new Ia(Ra, t.shape, e.shape);
    return this.compileAndRun(n, [t, e]);
  }, o.prototype.elu = function (t) {
    if (i().getBool("WEBGL_PACK_UNARY_OPERATIONS")) return this.packedUnaryOp(t, Bs, t.dtype);
    var e = new hs(t.shape, ms);
    return this.compileAndRun(e, [t]);
  }, o.prototype.eluDer = function (t, e) {
    var n = i().getBool("WEBGL_PACK_BINARY_OPERATIONS") ? new Sa("\n  vec4 bGTEZero = vec4(greaterThanEqual(b, vec4(0.)));\n  return (bGTEZero * a) + ((vec4(1.0) - bGTEZero) * (a * (b + vec4(1.0))));\n", t.shape, e.shape) : new Ia("return (b >= 1.0) ? a : a * (b + 1.0);", t.shape, e.shape);
    return this.compileAndRun(n, [t, e]);
  }, o.prototype.selu = function (t) {
    var e = new hs(t.shape, ys);
    return this.compileAndRun(e, [t]);
  }, o.prototype.int = function (t) {
    var e = new hs(t.shape, "return float(int(x));");
    return this.compileAndRun(e, [t], "int32");
  }, o.prototype.clip = function (t, e, n) {
    var r,
        o = (r = i().getBool("WEBGL_PACK_CLIP") ? new Da(t.shape) : new Aa(t.shape)).getCustomSetupFunc(e, n);
    ...
    if (p || !i().getBool("WEBGL_LAZILY_UNPACK") || !i().getBool("WEBGL_PACK_BINARY_OPERATIONS") || !d) {
    ...
    var x = f ? s[0] * s[1] * (s[2] + 1) : s[0] * s[2] * (s[3] + 1),
      ...
      dtype: t.dtype
        ...
        w = u.shape;
    u.shape = u.shape.slice(), u.shape[u.shape.length - 2]++, y(Se(u.shape, b.shape), function () {
    ...
    var C = this.reshape(e, [1, n.inChannels, n.outChannels]),
      ...
      preluActivationWeights: a
        ...
        R = this.texData.get(E.dataId);
    return y(R.isPacked, function () {
      return "batchMatMul result is expected to be packed";
    }), u.shape = w, R.shape = n.outShape, Ft.makeTensorFromDataId(E.dataId, n.outShape, E.dtype);
    ...
    var i = n.filterWidth,
        ...
        v = t.squeeze([0]),
        g = e.reshape([1, f, -1]),
        m = new Si(d, v.shape, n),
        y = this.compileAndRun(m, [v]).reshape([1, d[0], d[1]]),
        x = null != r,
        b = null != a,
        w = o ? Us(o, !0) : null,
        C = new _i(y.shape, [1, p, n.outChannels], !0, !1, x, w, b),
        E = [y, g];
    ...
    var e,
        ...
        f = null != a,
        p = null != u;
    return f && h.push(a), p && h.push(u), c ? (e = new Ga(o, f, l, p), this.compileAndRun(e, h)) : (e = new za(o, f, l, p), this.compileAndRun(e, h));
  }, o.prototype.depthwiseConv2D = function (t, e, n) {
    var r;
    return i().getBool("WEBGL_PACK_DEPTHWISECONV") && n.strideWidth <= 2 && n.outChannels / n.inChannels == 1 ? (r = new Ga(n), this.compileAndRun(r, [t, e])) : (r = new za(n), this.compileAndRun(r, [t, e]));
    ...
    var o = i().getBool("WEBGL_PACK_IMAGE_OPERATIONS") ? new qi(t.shape, e, n, r) : new Hi(t.shape, e, n, r);
    ...
    var o = new Mi(t.size, e, n, r);
    return this.compileAndRun(o, [t]);
  }, o.prototype.diag = function (t) {
    var e = new Ya(t.size);
    return this.compileAndRun(e, [t]);
  }, o.prototype.nonMaxSuppression = function (t, e, n, r, o, a) {
    return sn("tf.nonMaxSuppression() in webgl locks the UI thread. Call tf.nonMaxSuppressionAsync() instead"), Lo(t.dataSync(), e.dataSync(), n, r, o, a);
  }, o.prototype.cropAndResize = function (t, e, n, r, o, a) {
    var i = new Ha(t.shape, e.shape, r, o, a);
    ...
    var r = t.shape[0],
        ...
        u = a * e,
        c = i / (e * e),
        l = new $a("NHWC" === n ? [r, s, u, c] : [r, c, s, u], e, n);
    ...
    var r = qr(0, t, n),
        ...
        l = t.reshape([a, o]),
        h = e.reshape([a, i]);
    if (0 === u) return Do(kn([]), n);
    var f = An(0),
        p = new Yi(a, o, l.rank, h.rank, s, c);
    ...
    var o = qr(0, t, n),
        ...
        s = o.strides,
        u = o.outputSize,
        c = new Yi(i, a, t.rank, e.rank, s, [u, 1], !1);
    ...
    var n = this.texData.get(t.dataId),
        r = new ri(ei, t.shape, e),
        o = new ri(ni, t.shape, e),
    ...
    if (t.packedOutput && (u.isPacked = !0), t.outPackingScheme === Mt.DENSE) {
    ...
    if (null != t.outTexUsage && (u.usage = t.outTexUsage), 0 === C(s.shape)) return u.values = F(s.dtype, 0), s;
    var l = [],
        h = e.map(function (e) {
      ...
      if (null == n.texture) {
        if (!t.packedInputs && C(e.shape) <= i().getNumber("WEBGL_SIZE_UPLOAD_UNIFORM")) return {
          shape: e.shape,
          texData: null,
          isUniform: !0,
      ...
      } else if (!!n.isPacked != !!t.packedInputs) e = n.isPacked ? a.unpackTensor(e) : a.packTensor(e), l.push(e), n = a.texData.get(e.dataId);else if (n.isPacked && !Se(n.shape, e.shape)) {
        var r = e,
            o = e.shape;
    ...
    if (g && (f = this.startTimer()), function (t, e, n, r, o) {
      ...
      r.texData.isPacked ? t.setOutputPackedMatrixTexture(a, s[0], s[1]) : t.setOutputMatrixTexture(a, s[0], s[1]), t.setProgram(e.webGLProgram), 1 === i().getNumber("WEBGL_VERSION") && null !== e.infLoc && t.gl.uniform1f(e.infLoc, 1 / 0), null !== e.nanLoc && t.gl.uniform1f(e.nanLoc, NaN), n.forEach(function (n, r) {
        ...
        if (null != a) if (n.isUniform) {
          if (C(n.shape) < 2) t.gl.uniform1f(a, n.uniformValues[0]);else {
    ...
    return Ft.makeTensorFromDataId(a.dataId, a.shape, a.dtype);
    ...
    if (null == i) {
      ...
      if (null == h && (h = Ie(r, u), n.texShape = h), null != a) {
        var f = Re(r),
            p = void 0,
            d = h[1],
            v = h[0],
            g = a instanceof Uint8Array;
        u ? (d = (e = Ht(h[0], h[1]))[0], v = e[1], p = new ti(f, [v, d], g)) : p = new Za(f, [v, d], g);
        var m = this.makeTensorInfo([v, d], o);
        this.texData.get(m.dataId).usage = g ? Bt.PIXELS : Bt.UPLOAD, this.gpgpu.uploadDenseMatrixToTexture(this.getTexture(m.dataId), d, v, a);
        var y = this.runWebGLProgram(p, [m], o, null, !0),
            x = this.texData.get(y.dataId);
        n.texture = x.texture, n.texShape = x.texShape, n.isPacked = x.isPacked, n.usage = x.usage, this.disposeData(m.dataId), this.texData.delete(y.dataId), n.values = null, l && (this.uploadWaitMs += Q() - c);
      } else {
...
_t() && Ft.registerBackend("webgl", function () {
  return new zs();
}, 2);
var Gs = Cn({
  square_: function (t) {
    var e = ln(t, "x", "square"),
        n = [e];
    return Ft.runKernelFunc(function (t, n) {
...
var Hs = Cn({
  abs_: function (t) {
    var e = ln(t, "x", "abs");
    return "complex64" === e.dtype ? Ft.runKernelFunc(function (t) {
      return t.complexAbs(e);
    }, {
      $x: e
    }) : Ft.runKernelFunc(function (t, n) {
      var r = t.abs(e);
      return n([e]), r;
    }, {
      x: e
  ...
  clipByValue_: function (t, e, n) {
    ...
    return Ft.runKernelFunc(function (t, o) {
      var a = t.clip(r, e, n);
      return o([r]), a;
    }, {
      x: r
  ...
  erf_: function (t) {
    var e = ln(t, "x", "erf");
    return y("int32" === e.dtype || "float32" === e.dtype, function () {
      return "Input dtype must be `int32` or `float32`.";
    }), "int32" === e.dtype && (e = e.toFloat()), Ft.runKernelFunc(function (t, n) {
      var r = t.erf(e);
      return n([e]), r;
    }, {
      $x: e
...
function Su(t, e, n, r, o, a) {
  ...
  null != o && (i = ln(o, "scale", "batchNorm")), null != r && (s = ln(r, "offset", "batchNorm")), y(l.rank === h.rank, function () {
    return "Batch normalization gradient requires mean and variance to have equal ranks.";
  }), y(null == s || l.rank === s.rank, function () {
    return "Batch normalization gradient requires mean and offset to have equal ranks.";
  }), y(null == i || l.rank === i.rank, function () {
  ...
  var f = [c, l, h, i];
  return Ft.runKernelFunc(function (t, e) {
    var n = t.batchNormalization(u, Au(l), Au(h), a, Au(i), Au(s));
    return e([c, l, h, i]), n;
  }, {
    x: c,
    mean: l,
    ...
    var p = r.sub(o),
        d = t.mul(c),
        v = hu(i.add(An(a))),
        g = v.mul(v).mul(v).mul(An(-.5));
    return {
      x: function () {
        return 1 === o.rank ? t.mul(Fr(v.as4D(1, 1, 1, o.shape[0]), h)).mul(c).reshape(r.shape) : t.mul(v).mul(c).reshape(r.shape);
      },
      mean: function () {
...
var Tu = Cn({
  batchNormalization2d_: function (t, e, n, r, o, a) {
    return void 0 === r && (r = .001), Du(), Ru(t, e, n, a, o, r);
  }
}),
    Nu = Cn({
  batchNormalization3d_: function (t, e, n, r, o, a) {
    return void 0 === r && (r = .001), Du(), Iu(t, e, n, a, o, r);
  }
}),
    Fu = Cn({
  batchNormalization4d_: function (t, e, n, r, o, a) {
    return void 0 === r && (r = .001), Du(), ku(t, e, n, a, o, r);
  }
}),
    _u = Cn({
  batchNormalization_: function (t, e, n, r, o, a) {
    return void 0 === r && (r = .001), Du(), Su(t, e, n, a, o, r);
  }
}),
    Ou = Cn({
  batchNorm_: Su
...
exports.batchNorm4d = Pu;
exports.batchNorm3d = Bu;
exports.batchNorm2d = Mu;
exports.batchNorm = Ou;
exports.batchNormalization = _u;
exports.batchNormalization4d = Fu;
exports.batchNormalization3d = Nu;
exports.batchNormalization2d = Tu;

var Lu = Cn({
  logicalAnd_: function (t, e) {
    var n = ln(t, "a", "logicalAnd", "bool"),
        r = ln(e, "b", "logicalAnd", "bool");
    return vo(n.shape, r.shape), Ft.runKernelFunc(function (t) {
  ...
  logicalXor_: function (t, e) {
    ...
    return vo(n.shape, r.shape), Uu(t, e).logicalAnd(Lu(t, e).logicalNot());
  }
}),
    zu = Cn({
  where_: function (t, e, n) {
    ...
    return x(r.shape, o.shape, "Error in where: "), 1 === a.rank ? y(a.shape[0] === r.shape[0], function () {
      return "The first dimension of `a` must match the size of `condition`.";
    }) : x(a.shape, o.shape, "Error in where: "), Ft.runKernelFunc(function (t, e) {
...
exports.whereAsync = Gu;
exports.where = zu;
exports.logicalXor = Vu;
exports.logicalOr = Uu;
exports.logicalNot = Wu;
exports.logicalAnd = Lu;
var Hu = Cn({
  add_: function (t, e) {
    var n,
        r = ln(t, "a", "add"),
        o = ln(e, "b", "add");
    n = It(r, o), r = n[0], o = n[1];
    ...
    qu = Cn({
  addN_: function (t) {
    y(Array.isArray(t), function () {
      return "The argument passed to tf.addN() must be a list of tensors";
    }), y(t.length >= 1, function () {
  ...
  div_: function (t, e) {
    var n,
        r = ln(t, "a", "div"),
        o = ln(e, "b", "div");
    if (n = It(r, o), r = n[0], o = n[1], "int32" === r.dtype && "int32" === o.dtype) return Qu(r, o);
    var a = vo(r.shape, o.shape);
    return Ft.runKernelFunc(function (t, e) {
  ...
  maximum_: function (t, e) {
    var n,
        r = ln(t, "a", "maximum"),
        o = ln(e, "b", "maximum");
    return n = It(r, o), r = n[0], o = n[1], "bool" === r.dtype && (r = r.toInt(), o = o.toInt()), vo(r.shape, o.shape), Ft.runKernelFunc(function (t, e) {
      var n = t.maximum(r, o);
      return e([r, o]), n;
    }, {
      a: r,
  ...
  pow_: function (t, e) {
    var n = ln(t, "base", "pow"),
        r = ln(e, "exp", "pow"),
        o = vo(n.shape, r.shape);
    return t = n.cast(Et(n.dtype, r.dtype)), e = r.cast(Et(n.dtype, r.dtype)), Ft.runKernelFunc(function (t, e) {
      var o = t.pow(n, r);
      return e([n, r, o]), o;
    }, {
      $base: n,
  ...
  squaredDifference_: function (t, e) {
    ...
    return n = It(r, o), r = n[0], o = n[1], vo(r.shape, o.shape), Ft.runKernelFunc(function (t, e) {
...
exports.subStrict = hc;
exports.sub = lc;
exports.squaredDifferenceStrict = cc;
exports.squaredDifference = uc;
exports.powStrict = sc;
exports.pow = ic;
exports.mulStrict = ac;
exports.mul = oc;
exports.modStrict = rc;
exports.mod = nc;
exports.minimumStrict = ec;
exports.minimum = tc;
exports.maximumStrict = Zu;
exports.maximum = Ju;
exports.floorDiv = Qu;
exports.divStrict = Yu;
exports.divNoNan = $u;
exports.div = Xu;
exports.atan2 = ju;
...
var fc = Cn({
  equal_: function (t, e) {
    var n,
        r = ln(t, "a", "equal"),
        o = ln(e, "b", "equal");
    return n = It(r, o), r = n[0], o = n[1], vo(r.shape, o.shape), Ft.runKernelFunc(function (t) {
      return t.equal(r, o);
    }, {
      $a: r,
      $b: o
...
exports.notEqualStrict = Ec;
exports.notEqual = Cc;
exports.lessStrict = wc;
exports.lessEqualStrict = bc;
exports.lessEqual = xc;
exports.less = yc;
exports.greaterStrict = mc;
exports.greaterEqualStrict = gc;
exports.greaterEqual = vc;
exports.greater = dc;
exports.equalStrict = pc;
exports.equal = fc;
...
var kc = Cn({
  ...
  unsortedSegmentSum_: function (t, e, n) {
    ...
    return y(R(n), function () {
      return "numSegments must be of dtype int";
    }), Ft.runKernelFunc(function (t, e) {
      ...
      return {
        $x: function () {
          return function (t, e) {
            for (var n = Ju(e, zn(e)), r = kc(t, n), o = vc(e, An(0, "int32")), a = r.rank - o.rank, i = 0; i < a; ++i) o = vr(o, i + 1);

            o = Lu(o, Bn(r.shape, "bool"));
            var s = zn(r);
            return zu(o, r, s);
          }(t, n);
        }
...
exports.unsortedSegmentSum = Sc;
exports.gather = kc;

var Ac = function (t, e, o) {
  return n(this, void 0, void 0, function () {
    var n, a, i, s, u, c, l, h, f, p, d, v, g;
    return r(this, function (r) {
      switch (r.label) {
        case 0:
          for (n = ln(t, "tensor", "boolMask"), a = ln(e, "mask", "boolMask", "bool"), i = null == o ? 0 : o, s = a.rank, u = n.shape, y(s > 0, function () {
            return "mask cannot be scalar";
          }), x(u.slice(i, i + s), a.shape, "mask's shape must match the first K dimensions of tensor's shape,"), c = 1, l = i; l < i + s; l++) c *= u[l];

          return h = u.slice(0, i).concat([c], u.slice(i + s)), f = n.reshape(h), p = a.reshape([-1]), [4, Gu(p)];

        case 1:
          return d = r.sent(), v = d.squeeze([1]), g = kc(f, v, i), t !== n && n.dispose(), e !== a && a.dispose(), v.dispose(), f.dispose(), p.dispose(), d.dispose(), [2, g];
      }
    });
  });
};

exports.booleanMaskAsync = Ac;

function Dc(t, e, n, r, o, a, i) {
  void 0 === a && (a = "NHWC"), y(t.length === e.rank, function () {
    return "Length of inShape (" + t.length + ") and rank of dy (" + e.rank + ") must match";
  });
  var s = t,
      u = e,
      c = !1;
  3 === e.rank && (c = !0, u = e.as4D(1, e.shape[0], e.shape[1], e.shape[2]), s = [1, t[0], t[1], t[2]]), y(4 === s.length, function () {
  ...
  var f = So(a),
    ...
    return {
      dy4D: function () {
        return _c(t, n, r, o, a, 1, i);
      },
      filter: function () {
        return Mc(t, s, n.shape, r, o, a, i);
      }
    };
  });
...
var Fc = Cn({
  conv1d_: function (t, e, n, r, o, a, i) {
    ...
    var s = ln(t, "x", "conv1d"),
        u = ln(e, "filter", "conv1d"),
        c = s,
        l = !1;
    2 === s.rank && (l = !0, c = s.as3D(1, s.shape[0], s.shape[1])), y(3 === c.rank, function () {
  ...
  conv2d_: function (t, e, n, r, o, a, i) {
    ...
    var s = ln(t, "x", "conv2d"),
        u = ln(e, "filter", "conv2d"),
        c = s,
        l = !1;
    3 === s.rank && (l = !0, c = s.as4D(1, s.shape[0], s.shape[1], s.shape[2])), y(4 === c.rank, function () {
    ...
    var f = So(o),
        p = yo(c.shape, u.shape, n, a, r, i, !1, f),
        d = [u, c],
        v = Ft.runKernelFunc(function (t, e) {
  ...
  conv3d_: function (t, e, n, r, o, a) {
    ...
    var i = ln(t, "x", "conv3d"),
        s = ln(e, "filter", "conv3d"),
        u = i,
        c = !1;
    4 === i.rank && (c = !0, u = i.as5D(1, i.shape[0], i.shape[1], i.shape[2], i.shape[3])), y(5 === u.rank, function () {
    ...
    }), y(u.shape[4] === s.shape[3], function () {
    ...
    var l = xo(u.shape, s.shape, n, a, r),
        h = Ft.runKernelFunc(function (t, e) {
  ...
  conv2dDerFilter_: function (t, e, n, r, o, a, i) {
    ...
    var u = e;
    3 === u.rank && (u = e.as4D(1, e.shape[0], e.shape[1], e.shape[2])), y(4 === s.rank, function () {
  ...
  depthwiseConv2d_: function (t, e, n, r, o, a, i) {
    void 0 === o && (o = "NHWC"), void 0 === a && (a = [1, 1]);
    var s = ln(t, "x", "depthwiseConv2d"),
        u = ln(e, "filter", "depthwiseConv2d"),
        c = s,
        l = !1;
    3 === s.rank && (l = !0, c = s.as4D(1, s.shape[0], s.shape[1], s.shape[2])), y(4 === c.rank, function () {
    ...
    }), y(c.shape[3] === u.shape[2], function () {
    ...
    }), null == a && (a = [1, 1]), y(ko(n, a), function () {
    ...
    var h = yo(c.shape, u.shape, n, a, r, i, !0),
        f = [c, u],
        p = Ft.runKernelFunc(function (t, e) {
      ...
      return {
        x: function () {
          return Lc(n.shape, t, r, h);
        },
        filter: function () {
          return Wc(n, t, r.shape, h);
        }
      };
  ...
  depthwiseConv2dDerInput_: function (t, e, n, r) {
    ...
    var i = Ft.runKernelFunc(function (t) {
  ...
  depthwiseConv2dDerFilter_: function (t, e, n, r) {
    ...
    var a = e;
    return 3 === a.rank && (a = e.as4D(1, e.shape[0], e.shape[1], e.shape[2])), Ft.runKernelFunc(function (t) {
  ...
  conv2dTranspose_: function (t, e, n, r, o, a) {
    return Dc(n, ln(t, "x", "conv2dTranspose"), ln(e, "filter", "conv2dTranspose"), r, o, "NHWC", a);
  }
}),
    zc = Cn({
  conv3dTranspose_: function (t, e, n, r, o) {
    return Nc(n, ln(t, "x", "conv3dTranspose"), ln(e, "filter", "conv3dTranspose"), r, o);
  }
});

exports.conv3dTranspose = zc;
exports.conv2dTranspose = Vc;
exports.separableConv2d = Uc;
exports.depthwiseConv2d = Pc;
exports.conv3d = Oc;
exports.conv2d = _c;
exports.conv1d = Fc;
var Gc = Cn({
  matMul_: function (t, e, n, r) {
    ...
    var s = n ? a.shape[a.rank - 2] : a.shape[a.rank - 1],
        ...
        p = C(h),
        d = C(f);
    y(a.rank >= 2 && i.rank >= 2 && a.rank === i.rank, function () {
    ...
    var v = a.shape.slice(0, -2).concat([c, l]),
        g = n ? a.as3D(p, s, c) : a.as3D(p, c, s),
        m = r ? i.as3D(d, l, u) : i.as3D(d, u, l),
        x = {
      transposeA: n,
      transposeB: r
    };
  ...
  dot_: function (t, e) {
    var n = ln(t, "t1", "dot"),
        r = ln(e, "t2", "dot");
    y(!(1 !== n.rank && 2 !== n.rank || 1 !== r.rank && 2 !== r.rank), function () {
  ...
  outerProduct_: function (t, e) {
    ...
    return y(1 === n.rank && 1 === r.rank, function () {
...
var Kc = Cn({
  ...
  reverse4d_: function (t, e) {
    var n = ln(t, "x", "reverse");
    return y(4 === n.rank, function () {
      return "Error in reverse4D: x must be rank 4 but got rank " + n.rank + ".";
    }), Kc(n, e);
  }
});
exports.reverse4d = Yc;
exports.reverse3d = $c;
exports.reverse2d = Xc;
exports.reverse1d = jc;
exports.reverse = Kc;

function Qc(t, e, n, r, o, a) {
  var i = ln(t, "x", "maxPool"),
      s = i,
      u = !1;
  3 === i.rank && (u = !0, s = i.as4D(1, i.shape[0], i.shape[1], i.shape[2])), null == r && (r = [1, 1]), y(4 === s.rank, function () {
  ...
  }), null != a && y(R(o), function () {
    return "Error in maxPool: pad must be an integer when using, dimRoundingMode " + a + " but got pad " + o + ".";
  });
  var c = go(s.shape, e, n, r, o, a);
  if (1 === c.filterWidth && 1 === c.filterHeight && E(c.inShape, c.outShape)) return i.clone();
  var l = [s],
      h = Ft.runKernelFunc(function (t, e) {
    var n = t.maxPool(s, c);
    return e([s, n]), n;
...
function Jc(t, e, n, r, o, a) {
  ...
  null == r && (r = [1, 1]), y(ko(n, r), function () {
    return "Error in avgPool: Either strides or dilations must be 1. Got strides " + n + " and dilations '" + r + "'";
  });
  var s = i,
      u = !1;
  3 === i.rank && (u = !0, s = i.as4D(1, i.shape[0], i.shape[1], i.shape[2])), y(4 === s.rank, function () {
  ...
  var c = go(s.shape, e, n, r, o, a);
  if (1 === c.filterWidth && 1 === c.filterHeight && E(c.inShape, c.outShape)) return i.clone();
  var l = Ft.runKernelFunc(function (t) {
      ...
      x: function () {
        return function (t, e, n, r, o, a) {
          var i = ln(t, "dy", "avgPoolBackprop"),
              s = ln(e, "input", "avgPoolBackprop");
          y(s.rank === i.rank, function () {
          ...
          var h = go(u.shape, n, r, o, a),
              f = Ft.runKernelFunc(function (t) {
...
var Zc = Cn({
  ...
  pool_: function (t, e, n, r, o, a) {
    ...
    var i = ln(t, "x", "maxPool"),
        s = i,
        u = !1;
    3 === i.rank && (u = !0, s = i.as4D(1, i.shape[0], i.shape[1], i.shape[2])), y(ko(a, o), function () {
      return "Error in pool: Either strides or dilations must be 1. Got strides " + a + " and dilations '" + o + "'";
    });
    var c,
        l = go(s.shape, e, a, o, r),
  ...
  maxPool3d_: function (t, e, n, r, o, a, i) {
    void 0 === a && (a = "NDHWC");
    var s = ln(t, "x", "maxPool3d"),
        u = s,
        c = !1;
    4 === s.rank && (c = !0, u = s.as5D(1, s.shape[0], s.shape[1], s.shape[2], s.shape[3])), null == i && (i = [1, 1, 1]), y(5 === u.rank, function () {
    ...
    var l = mo(u.shape, e, n, i, r, o, a),
      ...
      return {
        x: function () {
          return function (t, e, n, r, o, a, i, s) {
            var u = ln(t, "dy", "maxPool3dBackprop"),
            ...
            var v = mo(f.shape, r, o, a, i, s),
                g = Ft.runKernelFunc(function (t) {
              return t.maxPool3dBackprop(h, f, p, v);
            }, {
              dy5D: h,
              input5D: f
            });
            if (d) return g.as4D(g.shape[1], g.shape[2], g.shape[3], g.shape[4]);
            return g;
          }(t, s, u, e, n, i, r, o);
        }
      };
  ...
  avgPool3d_: function (t, e, n, r, o, a, i) {
    void 0 === a && (a = "NDHWC");
    var s = ln(t, "x", "avgPool3d", "float32"),
        u = s,
        c = !1;
    4 === s.rank && (c = !0, u = s.as5D(1, s.shape[0], s.shape[1], s.shape[2], s.shape[3])), null == i && (i = [1, 1, 1]), y(5 === u.rank, function () {
      ...
      return {
        x: function () {
          return function (t, e, n, r, o, a, i) {
            var s = ln(t, "dy", "avgPool3dBackprop"),
                u = ln(e, "input", "avgPool3dBackprop"),
                c = s,
                l = u,
                h = !1;
            ...
            var f = mo(l.shape, n, r, o, a, i),
                p = Ft.runKernelFunc(function (t) {
              return t.avgPool3dBackprop(c, l, f);
            }, {
              dy5D: c,
              input5D: l
            });
            if (h) return p.as4D(p.shape[1], p.shape[2], p.shape[3], p.shape[4]);
            return p;
          }(t, u, e, n, i, r, o);
        }
      };
...
exports.avgPool3d = rl;
exports.maxPool3d = nl;
exports.pool = el;
exports.avgPool = tl;
exports.maxPool = Zc;
var ol = Cn({
...
var ll = Cn({
  all_: function (t, e, n) {
    ...
    var s = Ft.runKernelFunc(function (t) {
      return t.all(r, a);
    }, {
      $x: r
    });
  ...
  argMax_: function (t, e) {
    ...
    var r = T(e, n.shape),
        o = mn(r, n.rank);
    null != o && (n = n.transpose(o), r = xn(r.length, n.rank));
    var a = {
      axis: r[0]
    },
        i = [n];
  ...
  argMin_: function (t, e) {
    ...
    var r = T(e, n.shape),
        o = mn(r, n.rank);
    return null != o && (n = n.transpose(o), r = xn(r.length, n.rank)), Ft.runKernelFunc(function (t, e) {
  ...
  max_: function (t, e, n) {
    ...
    var r = ln(t, "x", "max"),
        ...
        i = a,
        s = mn(i, r.rank);
    null != s && (r = r.transpose(s), i = xn(i.length, r.rank));
    var u = [r],
        c = Ft.runKernelFunc(function (t, e) {
      var n = t.max(r, i);
      return e([o, n]), n;
    }, {
      x: r
    }, function (t, e) {
      return cl(t, e[1], e[0], a, s);
    }, "Max", {
      axes: i
    }, u, [!0]);
  ...
  moments_: function (t, e, n) {
    void 0 === e && (e = null), void 0 === n && (n = !1);
    var r = T(e, (t = ln(t, "x", "moments")).shape),
        o = t.mean(r, n),
        a = o.shape;
    n || (a = vn(o.shape, r));
  ...
  prod_: function (t, e, n) {
    ...
    var o = T(e, r.shape),
        ...
        i = o,
        s = r;
    null != a && (s = r.transpose(a), i = xn(i.length, r.rank));
    var u = Ft.runKernelFunc(function (t) {
      return t.prod(s, i);
    }, {
      permutedX: s
    });
...
var wl = Cn({
  elu_: function (t) {
    ...
    return Ft.runKernelFunc(function (t, n) {
      ...
      return {
        $x: function () {
          return Ft.runKernelFunc(function (e) {
            return e.eluDer(t, n);
          }, {
            dy: t,
            y: n
  ...
  prelu_: function (t, e) {
    ...
    return Ft.runKernelFunc(function (t, e) {
      ...
      return {
        x: function () {
          return zu(o, t, t.mul(r));
        },
        alpha: function () {
          var e = zu(o, zn(t), t.mul(n)),
              a = po(r.shape, t.shape);
  ...
  relu_: function (t) {
    var e = ln(t, "x", "relu");
    return "bool" === e.dtype ? e.toInt() : Ft.runKernelFunc(function (t, n) {
      var r = t.relu(e);
      return n([e]), r;
    }, {
      x: e
...
var Al = Cn({
  localResponseNormalization_: function (t, e, n, r, o) {
    ...
    var u = Ft.runKernelFunc(function (t, a) {
      ...
      return {
        x4D: function () {
          return Ft.runKernelFunc(function (a) {
...
var Tl = Cn({
  basicLSTMCell_: function (t, e, n, r, o, a) {
    var i = ln(t, "forgetBias", "basicLSTMCell"),
        s = ln(e, "lstmKernel", "basicLSTMCell"),
  ...
  multiRNNCell_: function (t, e, n, r) {
    for (var o = ln(e, "data", "multiRNNCell"), a = hn(n, "c", "multiRNNCell"), i = hn(r, "h", "multiRNNCell"), s = o, u = [], c = 0; c < t.length; c++) {
      var l = t[c](s, a[c], i[c]);
...
exports.multiRNNCell = Nl;
exports.basicLSTMCell = Tl;
var Fl = Cn({
  movingAverage_: function (t, e, n, r, o) {
    void 0 === o && (o = !0);
    var a = ln(t, "v", "movingAverage"),
        i = ln(e, "x", "movingAverage"),
        s = ln(n, "decay", "movingAverage");
    kt(a, i), y(E(a.shape, i.shape), function () {
...
var _l = Cn({
  stridedSlice_: function (t, e, n, r, o, a, i, s, u) {
    ...
    for (var f = 0; f < c.rank; f++) e[f] = $r(o, e, r, c.shape, f), n[f] = Yr(a, n, r, c.shape, f), r[f] = r[f] || 1;
    ...
    return r.every(function (t) {
      return 1 === t;
    }) ? ol(c, e, d).reshape(v) : Ft.runKernelFunc(function (t) {
...
var Ol = Cn({
  topk_: function (t, e, n) {
    ...
    var a = Ft.runKernelFunc(function (t) {
      return t.topk(r, e, n);
    }, {
      $x: r
    });
...
var Ml = Cn({
  scatterND_: function (t, e, n) {
    ...
    return Hr(o, r, n), Ft.runKernelFunc(function (t) {
...
exports.scatterND = Ml;
var Bl = Cn({
  fft_: function (t) {
    y("complex64" === t.dtype, function () {
  ...
  rfft_: function (t, e) {
    ...
    var u = n.zerosLike(),
        ...
        g = n.shape.slice();
    return g[n.shape.length - 1] = h, En(d[0], v[0]).reshape(g);
  }
}),
    Wl = Cn({
  irfft_: function (t) {
    ...
    var a = [n, 2 * (e - 1)],
        ...
        c = s.slice([0, 1], [n, e - 2]).reverse(1).mul(An(-1)),
        l = i.concat(u, 1),
        h = s.concat(c, 1);
    return r = En(l, h).as2D(a[0], a[1]), o = Pl(r), Rn(o);
  }
}),
    Ul = Object.freeze({
  fft: Bl,
...
var Vl = Cn({
  sparseToDense_: function (t, e, n, r) {
    ...
    }(o, a, n, i), Ft.runKernelFunc(function (t) {
  ...
  dropout_: function (t, e, n, r) {
    ...
    var a = function (t, e) {
      ...
      return e;
        ...
        i = 1 - e,
        s = Sr(a, 0, 1, "float32", r).add(i).floor().div(i);
...
var Kl = Cn({
  ...
  frame_: function (t, e, n, r, o) {
    ...
    for (var a = 0, i = []; a + e <= t.size;) i.push(ol(t, a, e)), a += n;

    if (r) for (; a < t.size;) {
      var s = a + e - t.size,
          u = Gn([ol(t, a, e - s), Ln([s], o)]);
      i.push(u), a += n;
    }
  ...
  stft_: function (t, e, n, r, o) {
    var a;
    void 0 === o && (o = Kl), null == r && (a = e, r = Math.floor(Math.pow(2, Math.ceil(Math.log(a) / Math.log(2)))));

    for (var i = Xl(t, e, n), s = oc(i, o(e)), u = [], c = 0; c < i.shape[0]; c++) u.push(Ll(s.slice([c, 0], [1, e]), r));
...
exports.hannWindow = Kl;

var Ql,
    Jl = function (t, e, o) {
  return void 0 === o && (o = 1), n(this, void 0, void 0, function () {
    var n, a, i, s, u, c, l, h, f, p, d, v, g, m;
    return r(this, function (r) {
      switch (r.label) {
        case 0:
          return n = ln(t, "predictions", "inTopK"), a = ln(e, "targets", "inTopK"), y(n.rank > 1, function () {
            return "inTopK() expects the predictions to be of rank 2 or higher, but got " + n.rank;
          }), y(n.rank - 1 === a.rank, function () {
            return "predictions rank should be 1 larger than targets rank, but got predictions rank " + n.rank + " and targets rank " + a.rank;
          }), x(n.shape.slice(0, n.shape.length - 1), a.shape, "predictions's shape should be align with the targets' shape, except the last dimension."), i = n.shape[n.shape.length - 1], y(o > 0 && o <= i, function () {
        ...
        case 2:
          for (u = r.sent(), c = [s.length / i, i], h = c[1], f = F("bool", l = c[0]), p = 0; p < l; p++) {
            for (d = p * h, v = s.subarray(d, d + h), g = [], m = 0; m < v.length; m++) g.push({
              value: v[m],
              index: m
            });
            ...
            for (g.sort(function (t, e) {
              return e.value - t.value;
            }), f[p] = 0, m = 0; m < o; m++) if (g[m].index === u[p]) {
              f[p] = 1;
              break;
            }
          }
...
var Zl = Cn({
  ...
  computeWeightedLoss_: function (t, e, n) {
    void 0 === n && (n = Ql.SUM_BY_NONZERO_WEIGHTS);
    var r = ln(t, "losses", "computeWeightedLoss"),
        o = null;
    null != e && (o = ln(e, "weights", "computeWeightedLoss"));
    var a = null == o ? r : r.mul(o);
    if (n === Ql.NONE) return a;
    if (n === Ql.SUM) return a.sum();

    if (n === Ql.MEAN) {
      if (null == o) return a.mean();
      var i = r.size / o.size,
          s = a.sum().div(o.sum());
      return i > 1 ? s.div(An(i)) : s;
    }

    if (n === Ql.SUM_BY_NONZERO_WEIGHTS) {
      if (null == o) return a.sum().div(An(r.size));
      var u = o.mul(Bn(r.shape)).notEqual(An(0)).sum().toFloat();
      return a.sum().div(u);
    }
  ...
  cosineDistance_: function (t, e, n, r, o) {
    void 0 === o && (o = Ql.SUM_BY_NONZERO_WEIGHTS);
    var a = ln(t, "labels", "cosineDistance"),
        i = ln(e, "predictions", "cosineDistance"),
        s = null;
    null != r && (s = ln(r, "weights", "cosineDistance")), x(a.shape, i.shape, "Error in cosineDistance: ");
    var u = An(1).sub(a.mul(i).sum(n, !0));
    return th(u, s, o);
  }
}),
    nh = Cn({
  hingeLoss_: function (t, e, n, r) {
    ...
    var o = ln(t, "labels", "hingeLoss"),
        ...
        i = null;
    null != n && (i = ln(n, "weights", "hingeLoss")), x(o.shape, a.shape, "Error in hingeLoss: ");
    var s = An(1);
    o = An(2).mul(o).sub(s);
  ...
  huberLoss_: function (t, e, n, r, o) {
    void 0 === r && (r = 1), void 0 === o && (o = Ql.SUM_BY_NONZERO_WEIGHTS);
    var a = ln(t, "labels", "huberLoss"),
        i = ln(e, "predictions", "huberLoss"),
        s = null;
    null != n && (s = ln(n, "weights", "huberLoss")), x(a.shape, i.shape, "Error in huberLoss: ");
    var u = An(r),
        c = i.sub(a).abs(),
        l = tc(c, u),
        h = c.sub(l),
        f = An(.5).mul(l.square()).add(u.mul(h));
    return th(f, s, o);
  }
}),
    oh = Cn({
  logLoss_: function (t, e, n, r, o) {
    void 0 === r && (r = 1e-7), void 0 === o && (o = Ql.SUM_BY_NONZERO_WEIGHTS);
    var a = ln(t, "labels", "logLoss"),
        i = ln(e, "predictions", "logLoss"),
        s = null;
    null != n && (s = ln(n, "weights", "logLoss")), x(a.shape, i.shape, "Error in logLoss: ");
    var u = An(1),
        c = An(r),
  ...
  meanSquaredError_: function (t, e, n, r) {
    ...
    var o = ln(t, "labels", "meanSquaredError"),
        ...
        i = null;
    null != n && (i = ln(n, "weights", "meanSquaredError")), x(o.shape, a.shape, "Error in meanSquaredError: ");
  ...
  sigmoidCrossEntropy_: function (t, e, n, r, o) {
    void 0 === r && (r = 0), void 0 === o && (o = Ql.SUM_BY_NONZERO_WEIGHTS);
    var a = ln(t, "multiClassLabels", "sigmoidCrossEntropy"),
        i = ln(e, "logits", "sigmoidCrossEntropy"),
        s = null;

    if (null != n && (s = ln(n, "weights", "sigmoidCrossEntropy")), x(a.shape, i.shape, "Error in sigmoidCrossEntropy: "), r > 0) {
      var u = An(r),
          c = An(1),
          l = An(.5);
  ...
  softmaxCrossEntropy_: function (t, e, n, r, o) {
    ...
    if (null != n && (s = ln(n, "weights", "softmaxCrossEntropy")), x(a.shape, i.shape, "Error in softmaxCrossEntropy: "), r > 0) {
      var u = An(r),
          c = An(1),
          l = An(a.shape[1]);
...
function ch(t, e) {
  return void 0 === e && (e = !1), Ft.tidy(function () {
    if (2 !== t.shape.length) throw new Error("qr2d() requires a 2D Tensor, but got a " + t.shape.length + "D Tensor.");

    for (var n = t.shape[0], r = t.shape[1], o = gr(n), a = t.clone(), i = Tn([[1]], [1, 1]), s = i.clone(), u = n >= r ? r : n, c = function (t) {
      var e,
          u = a,
          c = s,
          l = o;
      e = Ft.tidy(function () {
        ...
        if (0 === t) a = d.sub(v.matMul(s.transpose().matMul(d)));else {
          var g = d.sub(v.matMul(s.transpose().matMul(d)));
          a = a.slice([0, 0], [t, r]).concat(g, 0);
        }
        var m = o.slice([0, t], [n, o.shape[1] - t]);
        if (0 === t) o = m.sub(m.matMul(s).matMul(v.transpose()));else {
          var y = m.sub(m.matMul(s).matMul(v.transpose()));
          o = o.slice([0, 0], [n, t]).concat(y, 1);
        }
        return [s, a, o];
      }), s = e[0], a = e[1], o = e[2], Xe([u, c, l]);
    }, l = 0; l < u; ++l) c(l);
...
var lh = Cn({
  bandPart_: function (t, e, n) {
    ...
    e < 0 && (e = i), n < 0 && (n = s);
    var u = Un(0, i, 1, "int32").reshape([-1, 1]),
        c = Un(0, s, 1, "int32"),
        l = lc(u, c),
        h = Lu(l.lessEqual(An(+e, "int32")), l.greaterEqual(An(-n, "int32"))),
        f = Pn([i, s], r.dtype);
    return Nr(Or(r.reshape([-1, i, s])).map(function (t) {
      return zu(h, t, f);
    })).reshape(o);
  }
}),
  ...
  gramSchmidt_: function (t) {
    ...
    if (Array.isArray(t)) {
      e = !1, y(null != t && t.length > 0, function () {
        return "Gram-Schmidt process: input must not be null, undefined, or empty";
      });

      for (var n = t[0].shape[0], r = function (e) {
        y(t[e].shape[0] === n, function () {
    ...
    y(t.length <= t[0].shape[0], function () {
    ...
    var a = [],
        i = t,
        s = function (t) {
      a.push(Ft.tidy(function () {
        var e = i[t];
        if (t > 0) for (var n = 0; n < t; ++n) {
          var r = xl(a[n].mulStrict(e)).mul(a[n]);
          e = e.sub(r);
        }
        return e.div(Dl(e, "euclidean"));
      }));
    };
  ...
  qr_: function (t, e) {
    ...
    return r.forEach(function (t) {
      var n = ch(t, e),
          ...
          i = n[1];
      o.push(r), a.push(i);
    }), [Nr(o, 0).reshape(t.shape), Nr(a, 0).reshape(t.shape)];
  }
}),
    ph = Object.freeze({
  bandPart: lh,
...
var vh = Cn({
  resizeBilinear_: function (t, e, n) {
    ...
    var i = e[0],
        s = e[1],
        u = Ft.runKernelFunc(function (t, e) {
  ...
  resizeNearestNeighbor_: function (t, e, n) {
    ...
    }), y("float32" === r.dtype || "int32" === r.dtype, function () {
    ...
    mh = Cn({
  nonMaxSuppression_: function (t, e, n, r, o, a) {
    void 0 === r && (r = .5), void 0 === o && (o = Number.NEGATIVE_INFINITY), void 0 === a && (a = 0);
    var i = ln(t, "boxes", "nonMaxSuppression"),
        s = ln(e, "scores", "nonMaxSuppression"),
        u = dh(i, s, n, r, o, a);
    n = u.maxOutputSize, r = u.iouThreshold, o = u.scoreThreshold;
    var c = {
      maxOutputSize: n,
      iouThreshold: r,
      scoreThreshold: o
    ...
    return Ft.runKernelFunc(function (t) {
      return t.nonMaxSuppression(i, s, n, r, o, a);
    }, {
      boxes: i,
      scores: s
    }, null, "NonMaxSuppressionV3", c);
  }
}),
    yh = function (t, e, o, a, i, s) {
  return void 0 === a && (a = .5), void 0 === i && (i = Number.NEGATIVE_INFINITY), void 0 === s && (s = 0), n(this, void 0, void 0, function () {
    var n, u, c, l, h, f, p;
    return r(this, function (r) {
      switch (r.label) {
        case 0:
          return n = ln(t, "boxes", "nonMaxSuppressionAsync"), u = ln(e, "scores", "nonMaxSuppressionAsync"), c = dh(n, u, o, a, i, s), o = c.maxOutputSize, a = c.iouThreshold, i = c.scoreThreshold, s = c.softNmsSigma, [4, Promise.all([n.data(), u.data()])];

        case 1:
          return l = r.sent(), h = l[0], f = l[1], p = Lo(h, f, o, a, i, s), n !== t && n.dispose(), u !== e && u.dispose(), [2, p];
      }
    });
  });
},
  ...
  cropAndResize_: function (t, e, n, r, o, a) {
    ...
    bh = Object.freeze({
  resizeBilinear: vh,
  resizeNearestNeighbor: gh,
  nonMaxSuppression: mh,
  nonMaxSuppressionAsync: yh,
  cropAndResize: xh
}),
    wh = function (t, e) {
  return !(t > 0) || "linear" === e;
  ...
  throw new Error("Gradient for activation " + n + " has not been implemented yet.");
    ...
    Eh = function (t, e) {
  var n = e,
      r = po(t.shape, e.shape);
  return r.length > 0 && (n = n.sum(r)), n.reshape(t.shape);
},
    Rh = function (t, e, n) {
  if ("linear" === e) return t;
  if ("relu" === e) return Rl(t);
  if ("elu" === e) return wl(t);
  if ("relu6" === e) return Il(t);
  if ("prelu" === e) return El(t, n);
...
var Ih = Cn({
  fusedMatMul_: function (t) {
    ...
    if (!1 === wh(Ft.state.gradientDepth, l)) {
      var f = Gc(n, r, a, s);
      return null != u && (f = Hu(f, u)), Rh(f, l, h);
    }

    var p = ln(n, "a", "fused matMul"),
        d = ln(r, "b", "fused matMul");
    e = It(p, d), p = e[0], d = e[1];
    var v = a ? p.shape[p.rank - 2] : p.shape[p.rank - 1],
        g = s ? d.shape[d.rank - 1] : d.shape[d.rank - 2],
        m = a ? p.shape[p.rank - 1] : p.shape[p.rank - 2],
        x = s ? d.shape[d.rank - 2] : d.shape[d.rank - 1],
        b = p.shape.slice(0, -2),
        w = d.shape.slice(0, -2),
        R = C(b),
        I = C(w);
    y(p.rank >= 2 && d.rank >= 2 && p.rank === d.rank, function () {
      return "Error in fused matMul: inputs must have the same rank of at least 2, got ranks " + p.rank + " and " + d.rank + ".";
    }), y(E(b, w), function () {
      return "Error in fused matMul: outer dimensions (" + b + ") and (" + w + ") of Tensors with shapes " + p.shape + " and " + d.shape + " must match.";
    }), y(v === g, function () {
      return "Error in fused matMul: inner shapes (" + v + ") and (" + g + ") of Tensors with shapes " + p.shape + " and " + d.shape + " and transposeA=" + a + " and transposeB=" + s + " must match.";
    });
    var k,
        S,
        A = p.shape.slice(0, -2).concat([m, x]),
        D = a ? p.as3D(R, v, m) : p.as3D(R, m, v),
        T = s ? d.as3D(I, x, g) : d.as3D(I, g, x);
    null != u && vo(A, (k = It(k = ln(u, "bias", "fused matMul"), p)[0]).shape), null != h && (S = ln(h, "prelu weights", "fused matMul"));
    var N = {
      $a: D,
      $b: T
    };
    return null != u && (N.$bias = k), null != h && (N.$preluActivationWeights = S), Ft.runKernelFunc(function (t, e) {
  ...
  fusedConv2d_: function (t) {
    ...
    if (f = f || "linear", !1 === wh(Ft.state.gradientDepth, f)) {
      var d = _c(e, n, r, o, i, u, c);

      return null != l && (d = Hu(d, l)), Rh(d, f, p);
    }

    var v = ln(e, "x", "conv2d"),
        g = ln(n, "filter", "conv2d"),
        m = v,
        x = !1;
    3 === v.rank && (x = !0, m = v.as4D(1, v.shape[0], v.shape[1], v.shape[2])), y(4 === m.rank, function () {
    ...
    var b,
        w,
        C = yo(m.shape, g.shape, r, u, o, c);
    null != l && (b = It(b = ln(l, "bias", "fused conv2d"), v)[0], vo(C.outShape, b.shape)), null != p && (w = ln(p, "prelu weights", "fused conv2d"));
    var E = {
      x: m,
      filter: g
    };
    null != l && (E.bias = b), null != p && (E.preluActivationWeights = w);
    var I = [g, m],
        k = Ft.runKernelFunc(function (t, e) {
      var n = t.fusedConv2d({
        input: m,
        filter: g,
        convInfo: C,
      ...
      return null != l && (h = {
        ...
        x: function () {
          return Bc(i.shape, c, a, r, o);
        },
        filter: function () {
          return Mc(i, c, a.shape, r, o);
        }
      }, h);
    }, "FusedConv2D", {
      convInfo: C,
  ...
  fusedDepthwiseConv2d_: function (t) {
    ...
    if (!1 === wh(Ft.state.gradientDepth, f)) {
      var d = Pc(e, n, r, o, i, u, c);
      return null != l && (d = Hu(d, l)), Rh(d, f, p);
    }

    var v = ln(e, "x", "depthwiseConv2d"),
        g = ln(n, "filter", "depthwiseConv2d"),
        m = v,
        x = !1;
    3 === v.rank && (x = !0, m = v.as4D(1, v.shape[0], v.shape[1], v.shape[2])), y(4 === m.rank, function () {
    ...
    }), null == u && (u = [1, 1]), y(ko(r, u), function () {
    ...
    var b,
        w,
        C = yo(m.shape, g.shape, r, u, o, c, !0);
    null != l && (b = It(b = ln(l, "bias", "fused conv2d"), v)[0], vo(C.outShape, b.shape)), null != p && (w = ln(p, "prelu weights", "fused depthwiseConv2d"));
    var E = {
      x: m,
      filter: g
    };
    ...
    var I = [g, m],
      ...
      return null != l && (i = {
        ...
        x: function () {
          return Lc(r.shape, a, n, C);
        },
        filter: function () {
          return Wc(r, a, n.shape, C);
        }
      }, i);
  ...
  conv3dTranspose: zc,
  op: Cn,
  batchNormalization2d: Tu,
  batchNormalization3d: Nu,
  batchNormalization4d: Fu,
  ...
  pow: ic,
  powStrict: sc,
  squaredDifference: uc,
  squaredDifferenceStrict: cc,
  sub: lc,
  subStrict: hc,
  elu: wl,
  leakyRelu: Cl,
...
function Th(t, e) {
  Array.isArray(t) || (t = [t]), t.forEach(function (t) {
    null != t && y("complex64" !== t.dtype, function () {
...
var Fh = function (t) {
  ...
  return e(o, t), o.prototype.write = function (t, e, n) {
    ...
    var e = this.data.get(t),
        n = e.dtype,
        r = e.complexTensors;
    return "complex64" === n ? Fo(this.readSync(r.real.dataId), this.readSync(r.imag.dataId)) : this.data.get(t).values;
    ...
    if (Th(t, "slice"), Qr(t.shape, e, n)) {
      var r = Jr(e, t.strides),
          o = C(n);
      return kn(this.readSync(t.dataId).subarray(r, r + o), n, t.dtype);
    }

    for (var a = sr(n, t.dtype), i = this.bufferSync(t), s = 0; s < a.size; ++s) {
    ...
    for (var a = sr(o, t.dtype), i = this.bufferSync(t), s = 0; s < a.size; s++) {
    ...
    for (var e = this.readSync(t.dataId), n = sr([t.size, t.size], t.dtype), r = n.values, o = 0; o < e.length; o++) r[o * t.size + o] = e[o];
    ...
    for (var n = sr(t.shape, t.dtype), r = this.bufferSync(t), o = function (o) {
    ...
    var a = t.map(function (t) {
      var n = C(t.shape.slice(e));
      return t.as2D(-1, n);
    }),
        i = wn(a.map(function (t) {
      return t.shape;
    }), 1),
        s = sr(i, t[0].dtype).values;
    ...
    return kn(s, l, t[0].dtype);
  }, o.prototype.neg = function (t) {
    return Th(t, "neg"), this.multiply(An(-1), t);
  }, o.prototype.add = function (t, e) {
    ...
    }) : this.broadcastedBinaryOp(t, e, Et(t.dtype, e.dtype), function (t, e) {
      return t + e;
    });
  }, o.prototype.addN = function (t) {
    var e = this;
    ...
    }), r = sr(t[0].shape, t[0].dtype), o = r.values, a = 0; a < t.length; a++) for (var i = n[a], s = 0; s < o.length; s++) o[s] += i[s];
    ...
    return Th([t, e], "pow"), this.broadcastedBinaryOp(t, e, t.dtype, function (t, e) {
      return Math.pow(t, e);
    });
  }, o.prototype.batchMatMul = function (t, e, n, r) {
    Th([t, e], "matMul");

    for (var o = n ? t.shape[1] : t.shape[2], a = n ? t.shape[2] : t.shape[1], i = r ? e.shape[1] : e.shape[2], s = t.shape[0], u = this.readSync(t.dataId), c = this.readSync(e.dataId), l = n ? [t.strides[0], 1, t.strides[1]] : [t.strides[0], t.strides[1], 1], h = l[0], f = l[1], p = l[2], d = r ? [1, e.strides[1], e.strides[0]] : [e.strides[1], 1, e.strides[0]], v = d[0], g = d[1], m = d[2], y = a * i, x = sr([s, a, i], t.dtype), b = x.values, w = this.blockSize, C = 0; C < s; C++) for (var E = 0; E < a; E += w) for (var R = 0; R < i; R += w) for (var I = 0; I < o; I += w) for (var k = Math.min(E + w, a), S = Math.min(R + w, i), A = Math.min(I + w, o), D = E; D < k; D++) for (var T = R; T < S; T++) {
      for (var N = 0, F = I; F < A; F++) N += u[C * h + D * f + F * p] * c[F * v + T * g + C * m];
    ...
    return a && (u = this.add(u, a)), i && (u = Nh(this, u, i, s)), u;
  }, o.prototype.multiply = function (t, e) {
    return "complex64" === t.dtype || "complex64" === e.dtype ? this.broadcastedBinaryComplexOp(t.cast("complex64"), e.cast("complex64"), function (t, e, n, r) {
      return {
        real: t * n - e * r,
    ...
    Th(t, "sum"), gn("sum", e, t.rank);

    for (var n = dn(t.shape, e), r = n[0], o = n[1], a = Pn(r, Et(t.dtype, "int32")), i = C(o), s = this.readSync(a.dataId), u = this.readSync(t.dataId), c = 0; c < s.length; ++c) {
    ...
    Th(t, "unsortedSegmentSum");

    for (var r = [], o = t.rank - e.rank, a = 0; a < o; ++a) e = e.expandDims(a + 1);

    for (a = 0; a < n; ++a) {
      var i = An(a, "int32"),
          s = fc(i, e).asType("float32").mul(t).sum(0);
      r.push(s);
    }
    ...
    for (var r = dn(t.shape, n), o = r[0], a = r[1], i = Pn(o, "int32"), s = C(a), u = this.readSync(i.dataId), c = this.readSync(t.dataId), l = 0; l < u.length; ++l) {
    ...
    if (Th(t, "cumsum"), e !== t.rank - 1) throw new Error("backend.cumsum in CPU expects an inner-most axis=" + (t.rank - 1) + " but got axis=" + e);

    for (var o = Et(t.dtype, "int32"), a = Pn(t.shape, o), i = this.readSync(a.dataId), s = this.readSync(t.dataId), u = t.shape[t.rank - 1], c = r ? function (t, e) {
      return t + u - e - 1;
    } : function (t, e) {
      return t + e;
      ...
      if (0 === h) i[f] = n ? 0 : s[f];else {
        var p = c(l, h - 1);
        i[f] = n ? s[p] + i[p] : s[f] + i[p];
      }
    }

    return a;
  }, o.prototype.equal = function (t, e) {
    return Th([t, e], "equal"), this.broadcastedBinaryOp(t, e, "bool", function (t, e) {
      return t === e ? 1 : 0;
    });
  }, o.prototype.notEqual = function (t, e) {
    return Th([t, e], "notEqual"), this.broadcastedBinaryOp(t, e, "bool", function (t, e) {
      return t !== e ? 1 : 0;
    });
  }, o.prototype.less = function (t, e) {
    return Th([t, e], "less"), this.broadcastedBinaryOp(t, e, "bool", function (t, e) {
      return t < e ? 1 : 0;
    });
  }, o.prototype.lessEqual = function (t, e) {
    return Th([t, e], "lessEqual"), this.broadcastedBinaryOp(t, e, "bool", function (t, e) {
      return t <= e ? 1 : 0;
    });
  }, o.prototype.greater = function (t, e) {
    return Th([t, e], "greater"), this.broadcastedBinaryOp(t, e, "bool", function (t, e) {
      return t > e ? 1 : 0;
    });
  }, o.prototype.greaterEqual = function (t, e) {
    return Th([t, e], "greaterEqual"), this.broadcastedBinaryOp(t, e, "bool", function (t, e) {
      return t >= e ? 1 : 0;
    });
  }, o.prototype.logicalNot = function (t) {
    Th(t, "logicalNot");
    ...
    return Th([t, e], "logicalAnd"), this.broadcastedBinaryOp(t, e, "bool", function (t, e) {
      return t && e;
    });
  }, o.prototype.logicalOr = function (t, e) {
    return Th([t, e], "logicalOr"), this.broadcastedBinaryOp(t, e, "bool", function (t, e) {
      return t || e;
    });
  }, o.prototype.select = function (t, e, n) {
    Th([t, e, n], "select");

    for (var r = this.readSync(t.dataId), o = this.readSync(e.dataId), a = this.readSync(n.dataId), i = Pn(e.shape, Et(e.dtype, n.dtype)), s = this.readSync(i.dataId), u = 0, c = 0 === t.rank || t.rank > 1 || 1 === e.rank ? 1 : C(e.shape.slice(1)), l = 0; l < r.length; l++) for (var h = 0; h < c; h++) 1 === r[l] ? s[u++] = o[l] : s[u++] = a[l];
    ...
    return Th(t, "topk"), Ho(this.readSync(t.dataId), t.shape, t.dtype, e);
  }, o.prototype.min = function (t, e) {
    Th(t, "min"), gn("min", e, t.rank);

    for (var n = dn(t.shape, e), r = n[0], o = n[1], a = Pn(r, t.dtype), i = C(o), s = this.readSync(a.dataId), u = this.readSync(t.dataId), c = 0; c < s.length; ++c) {
    ...
    return Th([t, e], "minimum"), this.broadcastedBinaryOp(t, e, t.dtype, function (t, e) {
      return Math.min(t, e);
    });
  }, o.prototype.mod = function (t, e) {
    return Th([t, e], "mod"), this.broadcastedBinaryOp(t, e, t.dtype, function (t, e) {
      var n = t % e;
      return t < 0 && e < 0 || t >= 0 && e >= 0 ? n : (n + e) % e;
    });
  }, o.prototype.max = function (t, e) {
    Th(t, "max"), gn("max", e, t.rank);
    ...
    return Th([t, e], "maximum"), this.broadcastedBinaryOp(t, e, t.dtype, function (t, e) {
      return Math.max(t, e);
    });
  }, o.prototype.all = function (t, e) {
    Th(t, "all"), gn("all", e, t.rank);
    ...
    return Th([t, e], "squaredDifference"), this.broadcastedBinaryOp(t, e, t.dtype, function (t, e) {
      var n = t - e;
      return n * n;
    });
  }, o.prototype.ceil = function (t) {
    ...
    return Th([t, e], "prelu"), this.broadcastedBinaryOp(t, e, t.dtype, function (t, e) {
      return t < 0 ? e * t : t;
    });
  }, o.prototype.elu = function (t) {
    Th(t, "elu");
    ...
    for (var e = cs, n = ls, r = new Float32Array(t.size), o = this.readSync(t.dataId), a = 0; a < o.length; ++a) {
      var i = o[a];
    ...
    return Th([t, e], "atan2"), this.broadcastedBinaryOp(t, e, t.dtype, function (t, e) {
    ...
    var e = t.input,
        ...
        s = this.conv2d(e, n, r);
    return o && (s = this.add(s, o)), a && (s = Nh(this, s, a, i)), s;
  }, o.prototype.conv2d = function (t, e, n) {
    Th([t, e], "conv2d");

    for (var r = n.filterHeight, o = n.filterWidth, a = n.dilationHeight, i = n.dilationWidth, s = n.padInfo.left, u = n.padInfo.top, c = "channelsLast" === n.dataFormat, l = sr(n.outShape, t.dtype), h = t.strides[0], f = c ? t.strides[1] : t.strides[2], p = c ? t.strides[2] : 1, d = c ? 1 : t.strides[1], v = l.strides[0], g = c ? l.strides[1] : l.strides[2], m = c ? l.strides[2] : 1, y = c ? 1 : l.strides[1], x = this.readSync(t.dataId), b = this.readSync(e.dataId), w = l.values, C = 0; C < n.batchSize; ++C) for (var E = C * h, R = C * v, I = 0; I < n.outHeight; ++I) for (var k = R + I * g, S = I * n.strideHeight - u, A = 0; A < r; A++) {
      var D = S + A * a;
      if (!(D < 0 || D >= n.inHeight)) for (var T = A * e.strides[0], N = E + D * f, F = 0; F < n.outWidth; ++F) for (var _ = k + F * m, O = F * n.strideWidth - s, M = 0; M < o; M++) {
        var B = O + M * i;
        if (!(B < 0 || B >= n.inWidth)) for (var P = N + B * p, L = T + M * e.strides[1], W = 0; W < n.inChannels; ++W) {
          for (var U = x[P + W * d], V = 0; V < n.outChannels; ++V) w[_ + V * y] += U * b[L + V];
    ...
    for (var r = n.filterDepth, o = n.filterHeight, a = n.filterWidth, i = n.dilationDepth, s = n.dilationHeight, u = n.dilationWidth, c = n.padInfo.front, l = n.padInfo.left, h = n.padInfo.top, f = sr(n.outShape, t.dtype), p = this.readSync(t.dataId), d = this.readSync(e.dataId), v = f.values, g = 0; g < n.batchSize; ++g) for (var m = g * t.strides[0], y = g * f.strides[0], x = 0; x < n.outDepth; ++x) for (var b = y + x * f.strides[1], w = x * n.strideDepth - c, C = 0; C < r; C++) {
      var E = w + C * i;
      if (!(E < 0 || E >= n.inDepth)) for (var R = C * e.strides[0], I = m + E * t.strides[1], k = 0; k < n.outHeight; ++k) for (var S = b + k * f.strides[2], A = k * n.strideHeight - h, D = 0; D < o; D++) {
        var T = A + D * s;
        if (!(T < 0 || T >= n.inHeight)) for (var N = R + D * e.strides[1], F = I + T * t.strides[2], _ = 0; _ < n.outWidth; ++_) for (var O = S + _ * n.outChannels, M = _ * n.strideWidth - l, B = 0; B < a; B++) {
          ...
          if (!(P < 0 || P >= n.inWidth)) for (var L = N + B * e.strides[2], W = F + P * n.inChannels, U = L, V = 0; V < n.inChannels; ++V) {
            for (var z = p[W + V], G = 0; G < n.outChannels; ++G) v[O + G] += z * d[U + G];
    ...
    for (var r = sr(n.inShape, "float32"), o = r.values, a = r.strides, i = a[0], s = a[1], u = a[2], c = a[3], l = this.readSync(t.dataId), h = t.strides, f = h[0], p = h[1], d = h[2], v = h[3], g = this.readSync(e.dataId), m = e.strides, y = m[0], x = m[1], b = m[2], w = m[3], C = n.batchSize, E = n.filterDepth, R = n.filterHeight, I = n.filterWidth, k = n.inChannels, S = n.inDepth, A = n.inHeight, D = n.inWidth, T = n.outChannels, N = n.outDepth, F = n.outHeight, _ = n.outWidth, O = n.strideDepth, M = n.strideHeight, B = n.strideWidth, P = E - 1 - n.padInfo.front, L = R - 1 - n.padInfo.top, W = I - 1 - n.padInfo.left, U = 0; U < C; ++U) for (var V = 0; V < k; ++V) for (var z = 0; z < S; ++z) for (var G = z - P, H = Math.max(0, Math.ceil(G / O)), q = Math.min(N, (E + G) / O), K = 0; K < A; ++K) for (var j = K - L, X = Math.max(0, Math.ceil(j / M)), $ = Math.min(F, (R + j) / M), Y = 0; Y < D; ++Y) {
      for (var Q = Y - W, J = Math.max(0, Math.ceil(Q / B)), Z = Math.min(_, (I + Q) / B), tt = 0, et = H; et < q; ++et) for (var nt = et * O - G, rt = X; rt < $; ++rt) for (var ot = rt * M - j, at = J; at < Z; ++at) for (var it = f * U + p * et + d * rt + v * at, st = y * (E - 1 - nt) + x * (R - 1 - ot) + b * (I - 1 - (at * B - Q)) + w * V, ut = 0; ut < T; ++ut) {
        tt += l[it + ut] * g[st + ut];
      }
    ...
    Th([t, e], "conv2dDerFilter");

    for (var r = n.strideHeight, o = n.strideWidth, a = n.filterHeight, i = n.filterWidth, s = "channelsLast" === n.dataFormat, u = sr(n.filterShape, "float32"), c = n.padInfo.left, l = n.padInfo.top, h = this.bufferSync(t), f = this.bufferSync(e), p = 0; p < a; ++p) for (var d = Math.max(0, Math.ceil((l - p) / r)), v = Math.min(n.outHeight, (n.inHeight + l - p) / r), g = 0; g < i; ++g) for (var m = Math.max(0, Math.ceil((c - g) / o)), y = Math.min(n.outWidth, (n.inWidth + c - g) / o), x = 0; x < n.inChannels; ++x) for (var b = 0; b < n.outChannels; ++b) {
      for (var w = 0, C = 0; C < n.batchSize; ++C) for (var E = d; E < v; ++E) for (var R = p + E * r - l, I = m; I < y; ++I) {
        var k = g + I * o - c;
    ...
    Th([t, e], "depthwiseConv2D");

    for (var r = n.filterHeight, o = n.filterWidth, a = n.dilationHeight, i = n.dilationWidth, s = n.padInfo.left, u = n.padInfo.top, c = n.outChannels / n.inChannels, l = sr(n.outShape, t.dtype), h = this.readSync(t.dataId), f = this.readSync(e.dataId), p = l.values, d = 0; d < n.batchSize; ++d) for (var v = d * t.strides[0], g = d * l.strides[0], m = 0; m < n.outHeight; ++m) for (var y = g + m * l.strides[1], x = m * n.strideHeight - s, b = 0; b < r; ++b) {
      var w = x + b * a;
      if (!(w < 0 || w >= n.inHeight)) for (var C = b * e.strides[0], E = v + w * t.strides[1], R = 0; R < n.outWidth; ++R) for (var I = y + R * l.strides[2], k = R * n.strideWidth - u, S = 0; S < o; ++S) {
        ...
        if (!(A < 0 || A >= n.inWidth)) for (var D = C + S * e.strides[1], T = E + A * n.inChannels, N = I, F = D, _ = 0; _ < n.inChannels; ++_) {
          for (var O = h[T + _], M = 0; M < c; ++M) p[N + M] += O * f[F + M];
    ...
    Th([t, e], "depthwiseConv2DDerInput");

    for (var r = sr(n.inShape, "float32"), o = r.values, a = r.strides, i = a[0], s = a[1], u = a[2], c = this.readSync(t.dataId), l = t.strides, h = l[0], f = l[1], p = l[2], d = this.readSync(e.dataId), v = e.strides, g = v[0], m = v[1], y = v[2], x = n.batchSize, b = n.filterHeight, w = n.filterWidth, C = n.inChannels, E = n.inHeight, R = n.inWidth, I = n.outChannels, k = n.outHeight, S = n.outWidth, A = n.strideHeight, D = n.strideWidth, T = b - 1 - n.padInfo.top, N = w - 1 - n.padInfo.left, F = I / C, _ = 0; _ < x; ++_) for (var O = 0; O < C; ++O) for (var M = 0; M < E; ++M) for (var B = M - T, P = Math.max(0, Math.ceil(B / A)), L = Math.min(k, (b + B) / A), W = 0; W < R; ++W) {
      for (var U = W - N, V = Math.max(0, Math.ceil(U / D)), z = Math.min(S, (w + U) / D), G = 0, H = P; H < L; ++H) for (var q = H * A - B, K = V; K < z; ++K) for (var j = h * _ + f * H + p * K, X = g * (b - 1 - q) + m * (w - 1 - (K * D - U)) + y * O, $ = 0; $ < F; ++$) {
        G += c[j + (O * F + $)] * d[X + $];
      }
    ...
    Th([t, e], "depthwiseConv2DDerFilter");

    for (var r = n.strideHeight, o = n.strideWidth, a = n.filterHeight, i = n.filterWidth, s = sr(n.filterShape, "float32"), u = n.padInfo.left, c = n.padInfo.top, l = n.outChannels / n.inChannels, h = this.bufferSync(t), f = this.bufferSync(e), p = 0; p < a; ++p) for (var d = Math.max(0, Math.ceil((c - p) / r)), v = Math.min(n.outHeight, (n.inHeight + c - p) / r), g = 0; g < i; ++g) for (var m = Math.max(0, Math.ceil((u - g) / o)), y = Math.min(n.outWidth, (n.inWidth + u - g) / o), x = 0; x < n.outChannels; ++x) {
      for (var b = Math.trunc(x / l), w = x % l, C = 0, E = 0; E < n.batchSize; ++E) for (var R = d; R < v; ++R) for (var I = p + R * r - c, k = m; k < y; ++k) {
        var S = g + k * o - u;
    ...
    return Th(t, "tile"), Go(this.bufferSync(t), e);
  }, o.prototype.pad = function (t, e, n) {
    Th(t, "pad");
    ...
    for (var a = sr(r, t.dtype), i = this.bufferSync(t), s = 0; s < a.size; ++s) {
      var u = a.indexToLoc(s),
          c = u.slice();
      c[n] = o[u[n]];
    ...
    for (var r = e.strideHeight, o = e.strideWidth, a = e.dilationHeight, i = e.dilationWidth, s = e.effectiveFilterHeight, u = e.effectiveFilterWidth, c = e.padInfo.top, l = e.padInfo.left, h = "max" === n ? Number.NEGATIVE_INFINITY : Number.POSITIVE_INFINITY, f = this.readSync(t.dataId), p = sr(e.outShape, t.dtype), d = p.values, v = e.outShape[1] * e.outShape[2] * e.outShape[3], g = e.outShape[2] * e.outShape[3], m = e.outShape[3], y = 0; y < e.batchSize; ++y) for (var x = y * v, b = y * t.strides[0], w = 0; w < e.inChannels; ++w) for (var C = 0; C < e.outHeight; ++C) for (var E = C * r - c, R = Math.max(0, E), I = Math.min(e.inHeight, s + E), k = x + C * g, S = 0; S < e.outWidth; ++S) {
    ...
    for (var n = sr(e.outShape, "int32"), r = e.strideHeight, o = e.strideWidth, a = e.dilationHeight, i = e.dilationWidth, s = e.effectiveFilterHeight, u = e.effectiveFilterWidth, c = e.padInfo.top, l = e.padInfo.left, h = this.bufferSync(t), f = 0; f < e.batchSize; ++f) for (var p = 0; p < e.inChannels; ++p) for (var d = 0; d < e.outHeight; ++d) {
      for (var v = d * r - c, g = v; g < 0;) g += a;

      for (var m = Math.min(e.inHeight, s + v), y = 0; y < e.outWidth; ++y) {
        for (var x = y * o - l, b = x; b < 0;) b += i;

        for (var w = Math.min(e.inWidth, u + x), C = Number.NEGATIVE_INFINITY, E = -1, R = g; R < m; R += a) for (var I = R - v, k = b; k < w; k += i) {
          var S = k - x,
              A = h.get(f, R, k, p);
          A > C && (C = A, E = I * u + S);
        }
      ...
      for (var b = y - f, w = x - h, C = 0, E = 0; E < c; E += s) {
        ...
        if (!(R < 0 || R >= r.outHeight || Math.floor(R) !== R)) for (var I = 0; I < l; I += u) {
          ...
          if (!(k < 0 || k >= r.outWidth || Math.floor(k) !== k)) {
            var S = c * l - 1 - d.get(g, R, k, m) === E * l + I ? 1 : 0;
    ...
    return Th(t, "avgPool3d"), this.pool3d(t, e, "avg").toFloat();
  }, o.prototype.avgPool3dBackprop = function (t, e, n) {
    Th([t, e], "avgPool3dBackprop");

    for (var r = n.strideDepth, o = n.strideHeight, a = n.strideWidth, i = n.filterDepth, s = n.filterHeight, u = n.filterWidth, c = n.dilationDepth, l = n.dilationHeight, h = n.dilationWidth, f = n.effectiveFilterDepth, p = n.effectiveFilterHeight, d = n.effectiveFilterWidth, v = f - 1 - n.padInfo.front, g = d - 1 - n.padInfo.left, m = p - 1 - n.padInfo.top, y = sr(e.shape, "float32"), x = 1 / (i * s * u), b = this.bufferSync(t), w = 0; w < n.batchSize; ++w) for (var C = 0; C < n.inChannels; ++C) for (var E = 0; E < n.inDepth; ++E) for (var R = 0; R < n.inHeight; ++R) for (var I = 0; I < n.inWidth; ++I) {
      for (var k = E - v, S = R - m, A = I - g, D = 0, T = 0; T < f; T += c) {
        var N = (k + T) / r;
        if (!(N < 0 || N >= n.outDepth || Math.floor(N) !== N)) for (var F = 0; F < p; F += l) {
          var _ = (S + F) / o;

          if (!(_ < 0 || _ >= n.outHeight || Math.floor(_) !== _)) for (var O = 0; O < d; O += h) {
            var M = (A + O) / a;
    ...
    return Th(t, "avgPool"), this.pool(t, e, "avg").toFloat();
  }, o.prototype.resizeBilinear = function (t, e, n, r) {
    Th(t, "resizeBilinear");

    for (var o = t.shape, a = o[0], i = o[1], s = o[2], u = o[3], c = this.readSync(t.dataId), l = new Float32Array(C([a, e, n, u])), h = [r && e > 1 ? i - 1 : i, r && n > 1 ? s - 1 : s], f = [r && e > 1 ? e - 1 : e, r && n > 1 ? n - 1 : n], p = 0, d = h[0] / f[0], v = h[1] / f[1], g = 0; g < a; g++) for (var m = 0; m < e; m++) for (var y = d * m, x = Math.floor(y), b = y - x, w = Math.min(i - 1, Math.ceil(y)), E = g * t.strides[0] + x * t.strides[1], R = g * t.strides[0] + w * t.strides[1], I = 0; I < n; I++) for (var k = v * I, S = Math.floor(k), A = k - S, D = Math.min(s - 1, Math.ceil(k)), T = E + S * t.strides[2], N = R + S * t.strides[2], F = E + D * t.strides[2], _ = R + D * t.strides[2], O = 0; O < u; O++) {
      var M = c[T + O],
          B = c[N + O],
          P = M + (c[F + O] - M) * A,
          L = P + (B + (c[_ + O] - B) * A - P) * b;
    ...
    Th([t, e], "resizeBilinearBackprop");

    for (var r = e.shape, o = r[0], a = r[1], i = r[2], s = r[3], u = t.shape, c = u[1], l = u[2], h = new Float32Array(o * a * i * s), f = [n && c > 1 ? a - 1 : a, n && l > 1 ? i - 1 : i], p = [n && c > 1 ? c - 1 : c, n && l > 1 ? l - 1 : l], d = f[0] / p[0], v = f[1] / p[1], g = this.readSync(t.dataId), m = 0, y = 0; y < o; y++) for (var x = y * e.strides[0], b = 0; b < c; b++) for (var w = b * d, C = Math.floor(w), E = Math.min(Math.ceil(w), a - 1), R = x + C * e.strides[1], I = x + E * e.strides[1], k = w - C, S = 1 - k, A = 0; A < l; A++) for (var D = A * v, T = Math.floor(D), N = Math.min(Math.ceil(D), i - 1), F = D - T, _ = 1 - F, O = R + T * e.strides[2], M = R + N * e.strides[2], B = I + T * e.strides[2], P = I + N * e.strides[2], L = S * _, W = S * F, U = k * _, V = k * F, z = 0; z < s; z++) {
      var G = g[m++];
      h[O + z] += G * L, h[M + z] += G * W, h[B + z] += G * U, h[P + z] += G * V;
    }

    return Fn(h, [o, i, a, s], e.dtype);
  }, o.prototype.resizeNearestNeighbor = function (t, e, n, r) {
    Th(t, "resizeNearestNeighbor");

    for (var o = t.shape, a = o[0], i = o[1], s = o[2], u = o[3], c = this.readSync(t.dataId), l = new Float32Array(a * e * n * u), h = [r && e > 1 ? i - 1 : i, r && n > 1 ? s - 1 : s], f = [r && e > 1 ? e - 1 : e, r && n > 1 ? n - 1 : n], p = h[0] / f[0], d = h[1] / f[1], v = 0, g = 0; g < a; g++) for (var m = g * t.strides[0], y = 0; y < e; y++) for (var x = p * y, b = m + Math.min(i - 1, r ? Math.round(x) : Math.floor(x)) * t.strides[1], w = 0; w < n; w++) for (var C = d * w, E = b + Math.min(s - 1, r ? Math.round(C) : Math.floor(C)) * t.strides[2], R = 0; R < u; R++) {
      var I = c[E + R];
      l[v++] = I;
    }

    return kn(l, [a, e, n, u], t.dtype);
  }, o.prototype.resizeNearestNeighborBackprop = function (t, e, n) {
    Th([t, e], "resizeNearestNeighborBackprop");

    for (var r = e.shape, o = r[0], a = r[1], i = r[2], s = r[3], u = t.shape, c = u[1], l = u[2], h = new Float32Array(o * a * i * s), f = this.readSync(t.dataId), p = [n && c > 1 ? a - 1 : a, n && l > 1 ? i - 1 : i], d = [n && c > 1 ? c - 1 : c, n && l > 1 ? l - 1 : l], v = p[0] / d[0], g = p[1] / d[1], m = 1 / v, y = 1 / g, x = 2 * Math.ceil(m) + 2, b = 2 * Math.ceil(y) + 2, w = 0; w < o; w++) for (var C = w * e.strides[0], E = 0; E < a; E++) for (var R = C + E * e.strides[1], I = Math.floor(E * m), k = Math.floor(I - x / 2), S = 0; S < i; S++) for (var A = R + S * e.strides[2], D = Math.floor(S * y), T = Math.floor(D - b / 2), N = 0; N < s; N++) {
    ...
    Th([t, e, n, o, a], "batchNorm");

    for (var i = this.readSync(t.dataId), s = this.readSync(e.dataId), u = this.readSync(n.dataId), c = o ? this.readSync(o.dataId) : new Float32Array([1]), l = a ? this.readSync(a.dataId) : new Float32Array([0]), h = new Float32Array(i.length), f = l.length, p = c.length, d = u.length, v = s.length, g = 0, m = 0, y = 0, x = 0, b = 0; b < i.length; ++b) h[b] = l[g++] + (i[b] - s[m++]) * c[y++] / Math.sqrt(u[x++] + r), g >= f && (g = 0), m >= v && (m = 0), y >= p && (y = 0), x >= d && (x = 0);

    return Fn(h, t.shape);
  }, o.prototype.localResponseNormalization4D = function (t, e, n, r, o) {
    Th(t, "localResponseNormalization4D");
    var a = t.shape[3],
        i = a - 1,
    ...
    for (var s = t.shape[3], u = this.readSync(t.dataId), c = this.readSync(e.dataId), l = this.readSync(n.dataId), h = new Float32Array(t.size), f = t.size, p = 0; p < f; p++) {
      for (var d = p % s, v = p - d + Math.max(0, d - r), g = p - d + Math.min(s, d + r + 1), m = 0, y = v; y < g; y++) m += Math.pow(c[y], 2);

      m = a * m + o;

      for (y = v; y < g; y++) {
        var x = -2 * a * i * c[y] * l[p] / m;
        p === y && (x += Math.pow(m, -i)), x *= u[p], h[y] += x;
      }
    }
    ...
    for (var o = e ? t : so(t), a = o.shape[0], i = o.shape[1], s = Pn([a, n], "int32"), u = this.readSync(s.dataId), c = this.readSync(o.dataId), l = 0; l < a; ++l) {
      var h = l * i,
      ...
      for (var d = rr(r.toString()), v = l * n, g = 0; g < n; ++g) {
        var m = d();
        u[v + g] = f.length;
    ...
    return Th(t, "nonMaxSuppression"), Lo(this.readSync(t.dataId), this.readSync(e.dataId), n, r, o, a);
  }, o.prototype.fft = function (t) {
    return this.fftBatch(t, !1);
  }, o.prototype.ifft = function (t) {
    return this.fftBatch(t, !0);
  }, o.prototype.fftBatch = function (t, e) {
    for (var n = t.shape[0], r = t.shape[1], o = sr(t.shape, "float32"), a = sr(t.shape, "float32"), i = Rn(t).as2D(n, r), s = In(t).as2D(n, r), u = 0; u < n; u++) for (var c = i.slice([u, 0], [1, r]), l = s.slice([u, 0], [1, r]), h = En(c, l), f = this.readSync(this.fftImpl(h, e).dataId), p = 0; p < r; p++) {
      var d = _o(f, p);

      o.values[u * r + p] = d.real, a.values[u * r + p] = d.imag;
    }
    ...
    for (var r = t.shape[0], o = t.shape[1], a = t.shape[2], i = t.shape[3], s = o * e, u = a * e, c = i / (e * e), l = this.readSync(t.dataId), h = new Float32Array(r * s * u * c), f = 0, p = 0; p < r; ++p) for (var d = 0; d < s; ++d) for (var v = Math.floor(d / e), g = d % e, m = 0; m < u; ++m) for (var x = Math.floor(m / e), b = (g * e + m % e) * c, w = 0; w < c; ++w) {
    ...
    if (u.length + c.length === 0) for (var f = 0; f < l.length; f++) {
      var p = f % i.length,
          d = f % s.length,
          v = n(i[2 * p], i[2 * p + 1], s[2 * d], s[2 * d + 1]);
      ...
      var g = this.bufferSync(this.data.get(t.dataId).complexTensors.real),
        ...
        var p = g.locToIndex(f),
            d = a.slice(-e.rank);
        c.forEach(function (t) {
          return d[t] = 0;
        });
        var v = m.locToIndex(d),
            y = n(i[2 * p], i[2 * p + 1], s[2 * v], s[2 * v + 1]);
    ...
    for (var i = t.shape, s = i[0], u = i[1], c = i[2], l = i[3], h = e.shape[0], f = r[0], p = r[1], d = sr([h, f, p, l], "float32"), v = this.readSync(e.dataId), g = this.readSync(n.dataId), m = this.readSync(t.dataId), y = t.strides, x = d.strides, b = 0; b < h; b++) {
      var w = 4 * b,
          C = v[w],
          E = v[w + 1],
          R = v[w + 2],
          I = v[w + 3],
          k = g[b];
      if (!(k >= s)) for (var S = f > 1 ? (R - C) * (u - 1) / (f - 1) : 0, A = p > 1 ? (I - E) * (c - 1) / (p - 1) : 0, D = 0; D < f; D++) {
        var T = f > 1 ? C * (u - 1) + D * S : .5 * (C + R) * (u - 1);
        if (T < 0 || T > u - 1) for (var N = 0; N < p; N++) for (var F = 0; F < l; F++) {
          ...
          for (N = 0; N < p; N++) {
            if ((q = p > 1 ? E * (c - 1) + N * A : .5 * (E + I) * (c - 1)) < 0 || q > c - 1) for (F = 0; F < l; F++) {
              ...
              for (F = 0; F < l; F++) {
                ...
                _ = F + N * x[2] + D * x[1] + b * x[0], d.values[_] = G + (H - G) * B;
              }
            }
          }
        } else for (N = 0; N < p; ++N) {
    ...
    for (var c = new ht([i, s], t.dtype), l = this.readSync(e.dataId), h = this.readSync(t.dataId), f = 0; f < i; f++) {
      ...
      for (var m = 0; m < s; m++) c.values[f * s + m] = h[d * s + m];
    }
    ...
    for (var d = 0; d < a; d++) {
      ...
      for (var x = 0; x < o; x++) c ? p.values[g * o + x] += f[d * o + x] : p.values[g * o + x] = 0 === e.rank ? f[0] : f[d * o + x];
    }
...
Ft.registerBackend("cpu", function () {
  return new Fh();
}, 1), h({
  kernelName: "Square",
  backendName: "cpu",
...
h({
  ...
  kernelFunc: function (t) {
    var e = t.inputs,
        ...
        f = [h, l],
        p = [h, l, a];
    (u || s) && (null == _h && (_h = document.createElement("canvas").getContext("2d")), _h.canvas.width = l, _h.canvas.height = h, _h.drawImage(o, 0, 0, l, h), o = _h.canvas);
    var d = n.makeTensorInfo(f, "int32");
    n.texData.get(d.dataId).usage = Bt.PIXELS, n.gpgpu.uploadPixelDataToTexture(n.getTexture(d.dataId), o);
    var v = i().getBool("WEBGL_PACK") ? new Mh(p) : new Oh(p),
        g = n.runWebGLProgram(v, [d], "int32");
...
i().get("IS_BROWSER") && i().setPlatform("browser", new Bh());
...
var Ph,
  ...
  return t.prototype.fetch = function (t, e) {
    return null != i().global.fetch ? i().global.fetch(t, e) : (null == Ph && (Ph = Lh()), Ph(t, e));
  }, t.prototype.now = function () {
...
i().get("IS_NODE") && i().setPlatform("node", new Wh());
var Uh = {
  float32: 4,
  int32: 4,
  uint16: 2,
...
function zh(t, e) {
  for (var n = {}, r = 0, o = function (e) {
    ...
    if (("quantization" in e)) {
      ...
      for (var d = 0; d < p; d++) {
        var v = new Uint32Array(t.slice(r, r + Vh))[0];
        r += Vh;
...
function Xh(t) {
  ...
  return {
    ...
    modelTopologyBytes: null == t.modelTopology ? 0 : qh(JSON.stringify(t.modelTopology)),
    weightSpecsBytes: null == t.weightSpecs ? 0 : qh(JSON.stringify(t.weightSpecs)),
...
var $h = function () {
  ...
  return t.getInstance = function () {
    ...
    }), e.endsWith(Yh) && (e = e.slice(0, e.indexOf(Yh))), y(e.length > 0, function () {
      return "scheme must not be an empty string.";
    });
    var r = t.getInstance();
    y(null == r.managers[e], function () {
...
function Jh(t) {
  if (-1 === t.indexOf(Yh)) throw new Error("The url string provided does not contain a scheme. Supported schemes are: " + Qh.getSchemes().join(","));
  return {
    scheme: t.split(Yh)[0],
    path: t.split(Yh)[1]
  };
  ...
  return void 0 === o && (o = !1), n(this, void 0, void 0, function () {
    ...
    return r(this, function (r) {
      switch (r.label) {
        ...
        case 4:
          return f = r.sent(), !o || l ? [3, 6] : [4, Qh.getManager(u).removeModel(c)];
...
var of = function () {
  function t(t) {
    if (this.indexedDB = nf(), null == t || !t) throw new Error("For IndexedDB, modelPath must not be null, undefined or empty.");
    this.modelPath = t;
  }
  ...
  return t.prototype.save = function (t) {
    ...
    return new Promise(function (t, r) {
      ...
      o.onupgradeneeded = function () {
        ...
        if (null == e) {
          var i = a.transaction(tf, "readonly"),
              s = i.objectStore(tf).get(n.modelPath);
          ...
          f.onsuccess = function () {
            var o = (u = a.transaction(tf, "readwrite")).objectStore(tf).put({
              modelPath: n.modelPath,
              modelArtifacts: e,
              modelArtifactsInfo: c
            });
            o.onsuccess = function () {
              ...
              var e = (h = l.objectStore(ef)).delete(n.modelPath);
    ...
    af = function (t) {
  return i().getBool("IS_BROWSER") && !Array.isArray(t) && t.startsWith(of.URL_SCHEME) ? (e = t.slice(of.URL_SCHEME.length), new of(e)) : null;
  var e;
};

$h.registerSaveRouter(af), $h.registerLoadRouter(af);
...
var sf = function () {
  ...
  return t.prototype.listModels = function () {
      ...
      return r(this, function (e) {
        return [2, new Promise(function (e, n) {
          ...
          r.onupgradeneeded = function () {
            ...
            var t = r.result,
                o = t.transaction(ef, "readonly"),
                a = o.objectStore(ef).getAll();
    ...
    return n(this, void 0, void 0, function () {
      ...
      return r(this, function (n) {
        var r;
        return t = (r = t).startsWith(of.URL_SCHEME) ? r.slice(of.URL_SCHEME.length) : r, [2, new Promise(function (n, r) {
          ...
          o.onupgradeneeded = function () {
            ...
            u.onsuccess = function () {
              ...
              var o = s.delete(t),
                  i = function () {
                var o = (e = a.transaction(tf, "readwrite")).objectStore(tf).delete(t);
                o.onsuccess = function () {
...
if (i().getBool("IS_BROWSER")) try {
  Qh.registerManager(of.URL_SCHEME, new sf());
} catch (t) {}
var uf = "/",
    cf = "tensorflowjs_models",
    lf = "info",
    hf = "model_topology",
    ff = "weight_specs",
    pf = "weight_data",
...
function vf(t) {
  return {
    info: [cf, t, lf].join(uf),
    topology: [cf, t, hf].join(uf),
    weightSpecs: [cf, t, ff].join(uf),
    weightData: [cf, t, pf].join(uf),
    modelMetadata: [cf, t, df].join(uf)
  };
}
...
function gf(t) {
  ...
  return e.slice(1, e.length - 1).join(uf);
}
...
var mf = function () {
  function t(t) {
    ...
    this.modelPath = t, this.keys = vf(this.modelPath);
  }
  ...
  return t.prototype.save = function (t) {
    return n(this, void 0, void 0, function () {
      ...
      return r(this, function (r) {
        if (t.modelTopology instanceof ArrayBuffer) throw new Error("BrowserLocalStorage.save() does not support saving model topology in binary formats yet.");
        e = JSON.stringify(t.modelTopology), n = JSON.stringify(t.weightSpecs), o = Xh(t);
        ...
        try {
          return this.LS.setItem(this.keys.info, JSON.stringify(o)), this.LS.setItem(this.keys.topology, e), this.LS.setItem(this.keys.weightSpecs, n), this.LS.setItem(this.keys.weightData, function (t) {
            return Hh ? Buffer.from(t).toString("base64") : btoa(String.fromCharCode.apply(null, new Uint8Array(t)));
...
$h.registerSaveRouter(yf), $h.registerLoadRouter(yf);

var xf = function () {
  function t() {
    y(i().getBool("IS_BROWSER"), function () {
      return "Current environment is not a web browser";
    }), y(void 0 !== window.localStorage, function () {
  ...
  return t.prototype.listModels = function () {
    return n(this, void 0, void 0, function () {
      var t, e, n, o, a, i;
      return r(this, function (r) {
        for (t = {}, e = cf + uf, n = uf + lf, o = 0; o < this.LS.length; ++o) (a = this.LS.key(o)).startsWith(e) && a.endsWith(n) && (i = gf(a), t[i] = JSON.parse(this.LS.getItem(a)));
    ...
    return n(this, void 0, void 0, function () {
      ...
      return r(this, function (r) {
        var o;
        if (t = (o = t).startsWith(mf.URL_SCHEME) ? o.slice(mf.URL_SCHEME.length) : o, e = vf(t), null == this.LS.getItem(e.info)) throw new Error("Cannot find model at path '" + t + "'");
...
if (i().getBool("IS_BROWSER")) try {
  Qh.registerManager(mf.URL_SCHEME, new xf());
} catch (t) {}
var bf = "model",
    wf = ".json",
    Cf = ".weights.bin";
...
var Rf = function () {
  function t(e) {
    ...
    e.startsWith(t.URL_SCHEME) && (e = e.slice(t.URL_SCHEME.length)), null != e && 0 !== e.length || (e = bf), this.modelTopologyFileName = e + wf, this.weightDataFileName = e + Cf;
  }
      ...
      return r(this, function (r) {
        switch (r.label) {
          ...
          case 1:
            ...
            })), (i = null == this.jsonAnchor ? document.createElement("a") : this.jsonAnchor).download = this.modelTopologyFileName, i.href = a, [4, Ef(function () {
              return i.dispatchEvent(new MouseEvent("click"));
            })];

          case 2:
            return r.sent(), null == t.weightData ? [3, 4] : ((s = null == this.weightDataAnchor ? document.createElement("a") : this.weightDataAnchor).download = this.weightDataFileName, s.href = e, [4, Ef(function () {
...
function kf(t, e, n, r) {
  !function (t) {
    y(null != t && Array.isArray(t) && t.length > 0, function () {
...
$h.registerSaveRouter(function (t) {
  return i().getBool("IS_BROWSER") && !Array.isArray(t) && t.startsWith(Rf.URL_SCHEME) ? function (t) {
    void 0 === t && (t = "model");
    return new Rf(t);
  }(t.slice(Rf.URL_SCHEME.length)) : null;
});

var Df = function () {
  function t(t, e) {
    if (this.DEFAULT_METHOD = "POST", null == e && (e = {}), this.weightPathPrefix = e.weightPathPrefix, this.onProgress = e.onProgress, null != e.fetchFunc ? (y("function" == typeof e.fetchFunc, function () {
      return "Must pass a function that matches the signature of `fetch` (see https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API)";
    }), this.fetch = e.fetchFunc) : this.fetch = i().platform.fetch, y(null != t && t.length > 0, function () {
      return "URL path for http must not be null, undefined or empty.";
    }), Array.isArray(t) && y(2 === t.length, function () {
...
function Tf(t) {
  return null != t.match(Df.URL_SCHEME_REGEX);
}
...
$h.registerSaveRouter(Nf), $h.registerLoadRouter(Nf);
...
var Mf = Object.freeze({
                      ...
                      switch (r.label) {
                        ...
                        case 1:
                          for (e = r.sent(), n = e.reduce(function (t, e) {
                            return t + e.length;
                          }, 0) + Vh * e.length, o = new Uint8Array(n), a = 0, i = 0; i < e.length; i++) s = e[i], u = new Uint8Array(new Uint32Array([s.length]).buffer), o.set(u, a), a += Vh, o.set(s, a), a += s.length;
  ...
  fromMemory: function (t, e, n, r) {
    return 1 === arguments.length ? null != t.modelTopology || null != t.weightSpecs ? new _f(t) : (console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new _f({
      modelTopology: t
    })) : (console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new _f({
      modelTopology: t,
      weightSpecs: e,
      weightData: n,
      trainingConfig: r
  ...
  getLoadHandlers: function (t, e) {
    return $h.getLoadHandlers(t, e);
  },
  getModelArtifactsInfoForJSON: Xh,
  getSaveHandlers: function (t) {
    return $h.getSaveHandlers(t);
  },
  http: Ff,
  isHTTPScheme: Tf,
  ...
  registerLoadRouter: function (t) {
    return $h.registerLoadRouter(t);
  },
  registerSaveRouter: function (t) {
    return $h.registerSaveRouter(t);
  },
  weightsLoaderFactory: Af,
  ...
  listModels: function () {
    return n(this, void 0, void 0, function () {
      ...
      return r(this, function (r) {
        switch (r.label) {
          case 0:
            t = Qh.getSchemes(), e = {}, n = 0, o = t, r.label = 1;

          case 1:
            return n < o.length ? (a = o[n], [4, Qh.getManager(a).listModels()]) : [3, 4];

          case 2:
            for (s in i = r.sent()) e[a + Yh + s] = i[s];
  ...
  removeModel: function (t) {
    return n(this, void 0, void 0, function () {
      var e;
      return r(this, function (n) {
        return e = Jh(t), [2, Qh.getManager(e.scheme).removeModel(e.path)];
      });
    });
  }
});
...
var Bf,
  ...
  confusionMatrix_: function (t, e, n) {
    ...
    y(null == n || n > 0 && Number.isInteger(n), function () {
    ...
    }), y(r.shape[0] === o.shape[0], function () {
    ...
    }), y(n > 0 && Number.isInteger(n), function () {
      return "numClasses is required to be a positive integer, but got " + n;
    });
    var a = yr(r.asType("int32"), n),
        i = yr(o.asType("int32"), n);
...
var Wf = Cn({
  fromPixels_: function (t, e) {
    ...
    if (null != c("FromPixels", Ft.backendName)) return Ft.runKernel("FromPixels", {
      pixels: t
    }, {
      numChannels: e
    });
    var s,
        u,
        l = o ? [t.videoWidth, t.videoHeight] : [t.width, t.height],
        h = l[0],
        f = l[1];
    if (i ? s = t.getContext("2d").getImageData(0, 0, h, f).data : r || n ? s = t.data : (a || o) && (null == Bf && (Bf = document.createElement("canvas").getContext("2d")), Bf.canvas.width = h, Bf.canvas.height = f, Bf.drawImage(t, 0, 0, h, f), s = Bf.getImageData(0, 0, h, f).data), 4 === e) u = new Int32Array(s);else {
      var p = h * f;
      u = new Int32Array(p * e);

      for (var d = 0; d < p; d++) for (var v = 0; v < e; ++v) u[d * e + v] = s[4 * d + v];
    }
    return Nn(u, [f, h, e], "int32");
  }
}),
    Uf = Object.freeze({
  toPixels: function (t, e) {
    return n(this, void 0, void 0, function () {
      var n, o, a, i, s, u, c, l, h, f, p, d, v, g, m, y, x, b, w, C, E, R, I;
      return r(this, function (r) {
        switch (r.label) {
          case 0:
            if (n = ln(t, "img", "toPixels"), t instanceof vt || (n = n.toInt()), 2 !== n.rank && 3 !== n.rank) throw new Error("toPixels only supports rank 2 or 3 tensors, got rank " + n.rank + ".");
...
function Gf(t) {
  y(null != t.className, function () {
    return "Class being registered does not have the static className property defined.";
  }), y("string" == typeof t.className, function () {
    return "className is required to be a string, but got type " + typeof t.className;
  }), y(t.className.length > 0, function () {
...
var Hf = Object.freeze({
  ...
  registerClass: Gf
    ...
    qf = .001,
    Kf = .1;
exports.serialization = Hf;

function jf() {
  return 32 === Ft.backend.floatPrecision() ? qf : Kf;
}

function Xf(t, e, n) {
  var r = !0;

  if ((P(t) || P(e)) && (r = !1), P(t) && P(e) && (r = !0), r) {
  ...
  if (Array.isArray(t) && Array.isArray(e)) {
    var i = un(t),
        s = un(e);
    if (!E(i, s)) throw new Error("Arrays have different shapes. Actual: [" + i + "]. Expected: [" + s + "]");
  }
...
var Yf = Object.freeze({
  TEST_EPSILON_FLOAT16: Kf,
  expectArraysClose: function (t, e, n) {
    return null == n && (n = jf()), Xf(t, e, function (t, e) {
      return $f(t, e, n);
    });
  },
  testEpsilon: jf,
  ...
  expectArraysEqual: function (t, e) {
    ...
    return U(t) || U(t[0]) || U(e) || U(e[0]) ? Xf(t, n, function (t, e) {
      return t == e;
    }) : Xf(t, e, function (t, e) {
      return $f(t, e, 0);
    });
  ...
  expectNumbersClose: function (t, e, n) {
    if (null == n && (n = jf()), !$f(t, e, n)) throw new Error("Numbers differ: actual === " + t + ", expected === " + e);
  },
  ...
  expectArrayBuffersEqual: function (t, e) {
    ...
    Qf = "1.5.0";
exports.version_core = Qf;
exports.test_util = Yf;
...
exports.Optimizer = Zf;
exports.webgl = Jf;
Object.defineProperty(Zf, Symbol.hasInstance, {
  value: function (t) {
...
var tp = function (t) {
  function o(e, n, r) {
    ...
    return o.learningRate = e, o.rho = n, o.epsilon = r, o.accumulatedGrads = [], o.accumulatedUpdates = [], null == r && (o.epsilon = Ft.backend.epsilon()), o;
  }
    ...
    (Array.isArray(t) ? t.map(function (t) {
      ...
      if (null != a) {
        ...
        je(function () {
          ...
          i.assign(t);
          var n = a.div(t.add(Ft.backend.epsilon()).sqrt()).mul(-e.learningRate).add(o);
          o.assign(n);
        });
      }
    }), this.incrementIterations();
...
var np = function (t) {
  function o(e, n, r, o) {
    ...
    }), null == o && (a.epsilon = Ft.backend.epsilon()), a;
  }
        ...
        switch (r.label) {
          ...
          case 1:
            return t = r.sent(), je(function () {
              n.accBeta1.assign(ic(n.beta1, n.iterations_ + 1)), n.accBeta2.assign(ic(n.beta2, n.iterations_ + 1));
...
var rp = function (t) {
  function o(e, n, r, o, a) {
    ...
    }), null == o && (i.epsilon = Ft.backend.epsilon()), i;
  }
  ...
  return e(o, t), o.prototype.applyGradients = function (t) {
    ...
    je(function () {
      var r = lc(1, e.accBeta1),
          o = Xu(-e.learningRate, e.iteration.mul(e.decay).add(1));
      n.forEach(function (n, a) {
        var i = Ft.registeredVariables[n];
        null == e.accumulatedFirstMoment[a] && (e.accumulatedFirstMoment[a] = {
          originalName: n + "/m",
...
var ip = function (t) {
  function o(e, n, r, o, a) {
    ...
    var i = t.call(this) || this;
    return i.learningRate = e, i.decay = n, i.momentum = r, i.epsilon = o, i.accumulatedMeanSquares = [], i.accumulatedMoments = [], i.accumulatedMeanGrads = [], i.centered = a, null == o && (i.epsilon = Ft.backend.epsilon()), i;
  }
...
var sp = function () {
  ...
  return t.sgd = function (t) {
    ...
    return void 0 === n && (n = !1), new ap(t, e, n);
    ...
    return void 0 === t && (t = .001), void 0 === e && (e = .9), void 0 === n && (n = .999), void 0 === r && (r = null), new np(t, e, n, r);
  }, t.adadelta = function (t, e, n) {
    return void 0 === t && (t = .001), void 0 === e && (e = .95), void 0 === n && (n = null), new tp(t, e, n);
  }, t.adamax = function (t, e, n, r, o) {
    return void 0 === t && (t = .002), void 0 === e && (e = .9), void 0 === n && (n = .999), void 0 === r && (r = null), void 0 === o && (o = 0), new rp(t, e, n, r, o);
  }, t.adagrad = function (t, e) {
    return void 0 === e && (e = .1), new ep(t, e);
  }, t;
}(),
    up = {
  sgd: sp.sgd,
  momentum: sp.momentum,
  adadelta: sp.adadelta,
  adagrad: sp.adagrad,
  rmsprop: sp.rmsprop,
  adamax: sp.adamax,
  adam: sp.adam
},
    cp = "undefined" != typeof requestAnimationFrame ? requestAnimationFrame : "undefined" != typeof setImmediate ? setImmediate : function (t) {
  return t();
};
...
const predict = async () => {
  // shows loader and hides main (my code)
  document.getElementById("main").style.visibility = "hidden";
  document.getElementById("loader").style.visibility = "visible"; // shows loader and hides main (my code)
  ...
  addPredictions(predictions); // hides loader and shows main (my code)

  document.getElementById("loader").style.visibility = "hidden";
  document.getElementById("main").style.visibility = "visible"; // hides loader and shows main (my code)
  ...
  }); // listen the search event and fetchs twits (my code)
  ...
  document.querySelector('#search-button').addEventListener('click', async e => {
    ...
    console.log("buscando tweets de ".concat(text));
    const result = await fetch("https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name=".concat(text, "&count=5"), {
      headers: {
        'Authorization': 'Bearer AAAAAAAAAAAAAAAAAAAAAGDqHQEAAAAAYi1o9gOPPO2Y8Fs0pX%2Ffi42OCeM%3DphqPgevTq5soHfdicIlI56tux7jd6MgABJtMGkQs1u5ZD6ZECN'
      }
    });
    console.log('resultado:');
    console.log(result); /// fetch user using the text
  }); // listen the search event and fetchs twits (my code)
};

predict();
},{"@tensorflow-models/toxicity":"node_modules/@tensorflow-models/toxicity/dist/toxicity.esm.js"}]},{},["index.js"], null)
//# sourceMappingURL=/toxicity-classifier.e31bb0bc.js.map